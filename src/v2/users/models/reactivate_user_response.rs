...
impl ReactivateUserResponse {
	pub fn new() -> ReactivateUserResponse {
		ReactivateUserResponse { details: None }
	}
	...
	pub fn with_details(mut self, details: models::Details) -> ReactivateUserResponse {
		self.details = Some(details);
		self
	}
