...
impl RemovePasskeyResponse {
	pub fn new() -> RemovePasskeyResponse {
		RemovePasskeyResponse { details: None }
	}
	...
	pub fn with_details(mut self, details: models::Details) -> RemovePasskeyResponse {
		self.details = Some(details);
		self
	}
