...
mod user_service_update_user_body;
pub use self::user_service_update_user_body::UserServiceUpdateUserBody;
...
mod v2_update_user_request_human;
pub use self::v2_update_user_request_human::V2UpdateUserRequestHuman;
mod v2_update_user_request_machine;
pub use self::v2_update_user_request_machine::V2UpdateUserRequestMachine;
mod v2_update_user_response;
pub use self::v2_update_user_response::V2UpdateUserResponse;
mod userv2_type;
...
pub use self::set_metadata_entry::{SetMetadataEntry, SetMetadataEntry as ZitadelUserV2Metadata};
...
mod user_metadata_response;
pub use self::user_metadata_response::UserMetadataResponse;
mod get_user_metadata_response;
pub use self::get_user_metadata_response::GetUserMetadataResponse;
mod set_user_metadata_response;
pub use self::set_user_metadata_response::SetUserMetadataResponse;
mod list_user_metadata_request;
pub use self::list_user_metadata_request::ListUserMetadataRequest;
mod key_query;
pub use self::key_query::KeyQuery;
