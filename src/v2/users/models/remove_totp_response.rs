...
impl RemoveTotpResponse {
	pub fn new() -> RemoveTotpResponse {
		RemoveTotpResponse { details: None }
	}
	...
	pub fn with_details(mut self, details: models::Details) -> RemoveTotpResponse {
		self.details = Some(details);
		self
	}
