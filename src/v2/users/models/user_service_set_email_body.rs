...
pub struct UserServiceSetEmailBody {
	#[serde(rename = "email")]
	email: String,
...
impl UserServiceSetEmailBody {
	...
	pub fn with_email(mut self, email: String) -> UserServiceSetEmailBody {
		self.email = email;
		self
	}
	...
	pub fn with_is_verified(mut self, is_verified: bool) -> UserServiceSetEmailBody {
		self.is_verified = Some(is_verified);
		self
	}
