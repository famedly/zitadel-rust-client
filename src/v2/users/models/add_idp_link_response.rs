...
impl AddIdpLinkResponse {
	pub fn new() -> AddIdpLinkResponse {
		AddIdpLinkResponse { details: None }
	}
	...
	pub fn with_details(mut self, details: models::Details) -> AddIdpLinkResponse {
		self.details = Some(details);
		self
	}
