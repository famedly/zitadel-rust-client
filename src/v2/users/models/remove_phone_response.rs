...
impl RemovePhoneResponse {
	pub fn new() -> RemovePhoneResponse {
		RemovePhoneResponse { details: None }
	}
	...
	pub fn with_details(mut self, details: models::Details) -> RemovePhoneResponse {
		self.details = Some(details);
		self
	}
