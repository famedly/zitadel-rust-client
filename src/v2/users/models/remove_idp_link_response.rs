...
impl RemoveIdpLinkResponse {
	pub fn new() -> RemoveIdpLinkResponse {
		RemoveIdpLinkResponse { details: None }
	}
	...
	pub fn with_details(mut self, details: models::Details) -> RemoveIdpLinkResponse {
		self.details = Some(details);
		self
	}
