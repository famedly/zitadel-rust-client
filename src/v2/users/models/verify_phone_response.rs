...
impl VerifyPhoneResponse {
	pub fn new() -> VerifyPhoneResponse {
		VerifyPhoneResponse { details: None }
	}
	...
	pub fn with_details(mut self, details: models::Details) -> VerifyPhoneResponse {
		self.details = Some(details);
		self
	}
