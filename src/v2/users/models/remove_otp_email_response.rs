...
impl RemoveOtpEmailResponse {
	pub fn new() -> RemoveOtpEmailResponse {
		RemoveOtpEmailResponse { details: None }
	}
	...
	pub fn with_details(mut self, details: models::Details) -> RemoveOtpEmailResponse {
		self.details = Some(details);
		self
	}
