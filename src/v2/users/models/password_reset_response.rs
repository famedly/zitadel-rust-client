...
impl PasswordResetResponse {
	pub fn new() -> PasswordResetResponse {
		PasswordResetResponse { details: None, verification_code: None }
	}
	...
	pub fn with_details(mut self, details: models::Details) -> PasswordResetResponse {
		self.details = Some(details);
		self
	}
	...
	pub fn with_verification_code(mut self, verification_code: String) -> PasswordResetResponse {
		self.verification_code = Some(verification_code);
		self
	}
