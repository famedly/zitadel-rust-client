...
impl SetPhoneResponse {
	pub fn new() -> SetPhoneResponse {
		SetPhoneResponse { details: None, verification_code: None }
	}
	...
	pub fn with_details(mut self, details: models::Details) -> SetPhoneResponse {
		self.details = Some(details);
		self
	}
	...
	pub fn with_verification_code(mut self, verification_code: String) -> SetPhoneResponse {
		self.verification_code = Some(verification_code);
		self
	}
