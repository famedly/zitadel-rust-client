...
pub struct Zitadelmanagementv1GetDefaultVerifyEmailMessageTextResponse {
  #[serde(rename = "customText")]
  custom_text: Option<models::V1MessageCustomText>
}

impl Zitadelmanagementv1GetDefaultVerifyEmailMessageTextResponse {
  pub fn new() -> Zitadelmanagementv1GetDefaultVerifyEmailMessageTextResponse {
  ...
  pub fn with_custom_text(mut self, custom_text: models::V1MessageCustomText) -> Zitadelmanagementv1GetDefaultVerifyEmailMessageTextResponse {
    self.custom_text = Some(custom_text);
    self
  }
