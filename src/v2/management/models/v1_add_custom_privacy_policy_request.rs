...
pub struct V1AddCustomPrivacyPolicyRequest {
	/// If registration is enabled, the user has to accept the TOS. Variable
	/// {{.Lang}} can be set to have different links based on the language.
	#[serde(rename = "tosLink")]
	tos_link: Option<String>,
	/// If registration is enabled, the user has to accept the privacy terms.
	/// Variable {{.Lang}} can be set to have different links based on the
	/// language.
...
impl V1AddCustomPrivacyPolicyRequest {
	pub fn new() -> V1AddCustomPrivacyPolicyRequest {
	...
	pub fn with_tos_link(mut self, tos_link: String) -> V1AddCustomPrivacyPolicyRequest {
		self.tos_link = Some(tos_link);
		self
	}
	...
	pub fn with_privacy_link(mut self, privacy_link: String) -> V1AddCustomPrivacyPolicyRequest {
		self.privacy_link = Some(privacy_link);
		self
	}
	...
	pub fn with_help_link(mut self, help_link: String) -> V1AddCustomPrivacyPolicyRequest {
		self.help_link = Some(help_link);
		self
	}
	...
	pub fn with_support_email(mut self, support_email: String) -> V1AddCustomPrivacyPolicyRequest {
		self.support_email = Some(support_email);
		self
	}
	...
	pub fn with_docs_link(mut self, docs_link: String) -> V1AddCustomPrivacyPolicyRequest {
		self.docs_link = Some(docs_link);
		self
	}
	...
	pub fn with_custom_link(mut self, custom_link: String) -> V1AddCustomPrivacyPolicyRequest {
		self.custom_link = Some(custom_link);
		self
	}
