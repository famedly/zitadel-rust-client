...
pub struct Zitadelmanagementv1GetCustomInitMessageTextResponse {
  #[serde(rename = "customText")]
  custom_text: Option<models::V1MessageCustomText>
}

impl Zitadelmanagementv1GetCustomInitMessageTextResponse {
  pub fn new() -> Zitadelmanagementv1GetCustomInitMessageTextResponse {
  ...
  pub fn with_custom_text(mut self, custom_text: models::V1MessageCustomText) -> Zitadelmanagementv1GetCustomInitMessageTextResponse {
    self.custom_text = Some(custom_text);
    self
  }
