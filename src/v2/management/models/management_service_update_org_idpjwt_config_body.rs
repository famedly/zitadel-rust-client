...
impl ManagementServiceUpdateOrgIdpjwtConfigBody {
  pub fn new(jwt_endpoint: String, issuer: String, keys_endpoint: String, header_name: String) -> ManagementServiceUpdateOrgIdpjwtConfigBody {
  ...
  pub fn with_jwt_endpoint(mut self, jwt_endpoint: String) -> ManagementServiceUpdateOrgIdpjwtConfigBody {
    self.jwt_endpoint = jwt_endpoint;
    self
  }
  ...
  pub fn with_keys_endpoint(mut self, keys_endpoint: String) -> ManagementServiceUpdateOrgIdpjwtConfigBody {
    self.keys_endpoint = keys_endpoint;
    self
  }
  ...
  pub fn with_header_name(mut self, header_name: String) -> ManagementServiceUpdateOrgIdpjwtConfigBody {
    self.header_name = header_name;
    self
  }
