...
impl V1EmailVerificationScreenText {
  ...
  pub fn with_next_button_text(mut self, next_button_text: String) -> V1EmailVerificationScreenText {
    self.next_button_text = Some(next_button_text);
    self
  }
  ...
  pub fn with_resend_button_text(mut self, resend_button_text: String) -> V1EmailVerificationScreenText {
    self.resend_button_text = Some(resend_button_text);
    self
  }
