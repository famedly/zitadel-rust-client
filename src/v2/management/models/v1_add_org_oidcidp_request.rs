...
impl V1AddOrgOidcidpRequest {
  pub fn new(name: String, client_id: String, client_secret: String, issuer: String) -> V1AddOrgOidcidpRequest {
  ...
  pub fn with_styling_type(mut self, styling_type: models::V1IdpStylingType) -> V1AddOrgOidcidpRequest {
    self.styling_type = Some(styling_type);
    self
  }
  ...
  pub fn with_display_name_mapping(mut self, display_name_mapping: models::V1OidcMappingField) -> V1AddOrgOidcidpRequest {
    self.display_name_mapping = Some(display_name_mapping);
    self
  }
  ...
  pub fn with_username_mapping(mut self, username_mapping: models::V1OidcMappingField) -> V1AddOrgOidcidpRequest {
    self.username_mapping = Some(username_mapping);
    self
  }
