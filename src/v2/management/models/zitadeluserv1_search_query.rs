...
impl Zitadeluserv1SearchQuery {
  ...
  pub fn with_user_name_query(mut self, user_name_query: models::V1UserNameQuery) -> Zitadeluserv1SearchQuery {
    self.user_name_query = Some(user_name_query);
    self
  }
  ...
  pub fn with_first_name_query(mut self, first_name_query: models::Zitadeluserv1FirstNameQuery) -> Zitadeluserv1SearchQuery {
    self.first_name_query = Some(first_name_query);
    self
  }
  ...
  pub fn with_last_name_query(mut self, last_name_query: models::Zitadeluserv1LastNameQuery) -> Zitadeluserv1SearchQuery {
    self.last_name_query = Some(last_name_query);
    self
  }
  ...
  pub fn with_nick_name_query(mut self, nick_name_query: models::V1NickNameQuery) -> Zitadeluserv1SearchQuery {
    self.nick_name_query = Some(nick_name_query);
    self
  }
  ...
  pub fn with_display_name_query(mut self, display_name_query: models::V1DisplayNameQuery) -> Zitadeluserv1SearchQuery {
    self.display_name_query = Some(display_name_query);
    self
  }
  ...
  pub fn with_email_query(mut self, email_query: models::Zitadeluserv1EmailQuery) -> Zitadeluserv1SearchQuery {
    self.email_query = Some(email_query);
    self
  }
  ...
  pub fn with_state_query(mut self, state_query: models::V1StateQuery) -> Zitadeluserv1SearchQuery {
    self.state_query = Some(state_query);
    self
  }
  ...
  pub fn with_login_name_query(mut self, login_name_query: models::V1LoginNameQuery) -> Zitadeluserv1SearchQuery {
    self.login_name_query = Some(login_name_query);
    self
  }
  ...
  pub fn with_in_user_ids_query(mut self, in_user_ids_query: models::V1InUserIdQuery) -> Zitadeluserv1SearchQuery {
    self.in_user_ids_query = Some(in_user_ids_query);
    self
  }
  ...
  pub fn with_in_user_emails_query(mut self, in_user_emails_query: models::V1InUserEmailsQuery) -> Zitadeluserv1SearchQuery {
    self.in_user_emails_query = Some(in_user_emails_query);
    self
  }
