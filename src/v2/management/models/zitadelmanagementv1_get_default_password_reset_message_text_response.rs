...
pub struct Zitadelmanagementv1GetDefaultPasswordResetMessageTextResponse {
  #[serde(rename = "customText")]
  custom_text: Option<models::V1MessageCustomText>
}

impl Zitadelmanagementv1GetDefaultPasswordResetMessageTextResponse {
  pub fn new() -> Zitadelmanagementv1GetDefaultPasswordResetMessageTextResponse {
  ...
  pub fn with_custom_text(mut self, custom_text: models::V1MessageCustomText) -> Zitadelmanagementv1GetDefaultPasswordResetMessageTextResponse {
    self.custom_text = Some(custom_text);
    self
  }
