...
pub struct V1UpdateCustomLockoutPolicyRequest {
	/// When the user has reached the maximum password attempts the account will
	/// be locked, If this is set to 0 the lockout will not trigger.
...
impl V1UpdateCustomLockoutPolicyRequest {
	pub fn new() -> V1UpdateCustomLockoutPolicyRequest {
		V1UpdateCustomLockoutPolicyRequest { max_password_attempts: None, max_otp_attempts: None }
	}
	...
	pub fn with_max_password_attempts(
		mut self,
		max_password_attempts: i64,
	...
	pub fn with_max_otp_attempts(
		mut self,
		max_otp_attempts: i64,
	) -> V1UpdateCustomLockoutPolicyRequest {
		self.max_otp_attempts = Some(max_otp_attempts);
		self
	}
