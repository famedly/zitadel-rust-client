...
pub struct V1InitializeUserScreenText {
  #[serde(rename = "title")]
  title: Option<String>,
...
impl V1InitializeUserScreenText {
  pub fn new() -> V1InitializeUserScreenText {
  ...
  pub fn with_title(mut self, title: String) -> V1InitializeUserScreenText {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> V1InitializeUserScreenText {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_code_label(mut self, code_label: String) -> V1InitializeUserScreenText {
    self.code_label = Some(code_label);
    self
  }
  ...
  pub fn with_new_password_label(mut self, new_password_label: String) -> V1InitializeUserScreenText {
    self.new_password_label = Some(new_password_label);
    self
  }
  ...
  pub fn with_new_password_confirm_label(mut self, new_password_confirm_label: String) -> V1InitializeUserScreenText {
    self.new_password_confirm_label = Some(new_password_confirm_label);
    self
  }
  ...
  pub fn with_resend_button_text(mut self, resend_button_text: String) -> V1InitializeUserScreenText {
    self.resend_button_text = Some(resend_button_text);
    self
  }
  ...
  pub fn with_next_button_text(mut self, next_button_text: String) -> V1InitializeUserScreenText {
    self.next_button_text = Some(next_button_text);
    self
  }
