...
impl V1GitLabConfig {
	pub fn new() -> V1GitLabConfig {
		V1GitLabConfig { client_id: None, scopes: None }
	}
	...
	pub fn with_client_id(mut self, client_id: String) -> V1GitLabConfig {
		self.client_id = Some(client_id);
		self
	}
	...
	pub fn with_scopes(mut self, scopes: Vec<String>) -> V1GitLabConfig {
		self.scopes = Some(scopes);
		self
	}
