...
impl V1ManagementServiceMigrateGenericOidcProviderBody {
	pub fn new() -> V1ManagementServiceMigrateGenericOidcProviderBody {
		V1ManagementServiceMigrateGenericOidcProviderBody { azure: None, google: None }
	}
	...
	pub fn with_azure(
		mut self,
		azure: models::Zitadelmanagementv1AddAzureAdProviderRequest,
	...
	pub fn with_google(
		mut self,
		google: models::Zitadelmanagementv1AddGoogleProviderRequest,
	) -> V1ManagementServiceMigrateGenericOidcProviderBody {
		self.google = Some(google);
		self
	}
