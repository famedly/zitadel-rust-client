...
pub struct Zitadelmanagementv1GetCustomPasswordResetMessageTextResponse {
  #[serde(rename = "customText")]
  custom_text: Option<models::V1MessageCustomText>
}

impl Zitadelmanagementv1GetCustomPasswordResetMessageTextResponse {
  pub fn new() -> Zitadelmanagementv1GetCustomPasswordResetMessageTextResponse {
  ...
  pub fn with_custom_text(mut self, custom_text: models::V1MessageCustomText) -> Zitadelmanagementv1GetCustomPasswordResetMessageTextResponse {
    self.custom_text = Some(custom_text);
    self
  }
