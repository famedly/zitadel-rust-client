...
pub struct Zitadelmanagementv1GetCustomDomainClaimedMessageTextResponse {
  #[serde(rename = "customText")]
  custom_text: Option<models::V1MessageCustomText>
}

impl Zitadelmanagementv1GetCustomDomainClaimedMessageTextResponse {
  pub fn new() -> Zitadelmanagementv1GetCustomDomainClaimedMessageTextResponse {
  ...
  pub fn with_custom_text(mut self, custom_text: models::V1MessageCustomText) -> Zitadelmanagementv1GetCustomDomainClaimedMessageTextResponse {
    self.custom_text = Some(custom_text);
    self
  }
