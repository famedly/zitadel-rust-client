...
impl Zitadelmanagementv1GetLabelPolicyResponse {
  ...
  pub fn with_policy(mut self, policy: models::V1LabelPolicy) -> Zitadelmanagementv1GetLabelPolicyResponse {
    self.policy = Some(policy);
    self
  }
  ...
  pub fn with_is_default(mut self, is_default: bool) -> Zitadelmanagementv1GetLabelPolicyResponse {
    self.is_default = Some(is_default);
    self
  }
