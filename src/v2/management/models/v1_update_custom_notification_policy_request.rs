...
pub struct V1UpdateCustomNotificationPolicyRequest {
...
impl V1UpdateCustomNotificationPolicyRequest {
  pub fn new() -> V1UpdateCustomNotificationPolicyRequest {
  ...
  pub fn with_password_change(mut self, password_change: bool) -> V1UpdateCustomNotificationPolicyRequest {
    self.password_change = Some(password_change);
    self
  }
