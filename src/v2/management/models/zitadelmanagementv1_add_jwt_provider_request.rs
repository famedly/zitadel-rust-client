...
impl Zitadelmanagementv1AddJwtProviderRequest {
  ...
  pub fn with_jwt_endpoint(mut self, jwt_endpoint: String) -> Zitadelmanagementv1AddJwtProviderRequest {
    self.jwt_endpoint = Some(jwt_endpoint);
    self
  }
  ...
  pub fn with_keys_endpoint(mut self, keys_endpoint: String) -> Zitadelmanagementv1AddJwtProviderRequest {
    self.keys_endpoint = Some(keys_endpoint);
    self
  }
  ...
  pub fn with_header_name(mut self, header_name: String) -> Zitadelmanagementv1AddJwtProviderRequest {
    self.header_name = Some(header_name);
    self
  }
  ...
  pub fn with_provider_options(mut self, provider_options: models::V1Options) -> Zitadelmanagementv1AddJwtProviderRequest {
    self.provider_options = Some(provider_options);
    self
  }
