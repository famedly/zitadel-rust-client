...
pub struct Zitadelmanagementv1AddGitHubProviderRequest {
  ...
  /// Client secret generated by the GitHub
...
impl Zitadelmanagementv1AddGitHubProviderRequest {
  pub fn new() -> Zitadelmanagementv1AddGitHubProviderRequest {
  ...
  pub fn with_name(mut self, name: String) -> Zitadelmanagementv1AddGitHubProviderRequest {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_client_id(mut self, client_id: String) -> Zitadelmanagementv1AddGitHubProviderRequest {
    self.client_id = Some(client_id);
    self
  }
  ...
  pub fn with_client_secret(mut self, client_secret: String) -> Zitadelmanagementv1AddGitHubProviderRequest {
    self.client_secret = Some(client_secret);
    self
  }
  ...
  pub fn with_scopes(mut self, scopes: Vec<String>) -> Zitadelmanagementv1AddGitHubProviderRequest {
    self.scopes = Some(scopes);
    self
  }
  ...
  pub fn with_provider_options(mut self, provider_options: models::V1Options) -> Zitadelmanagementv1AddGitHubProviderRequest {
    self.provider_options = Some(provider_options);
    self
  }
