...
pub struct Zitadelmanagementv1GetCustomVerifyEmailOtpMessageTextResponse {
  #[serde(rename = "customText")]
  custom_text: Option<models::V1MessageCustomText>
}

impl Zitadelmanagementv1GetCustomVerifyEmailOtpMessageTextResponse {
  pub fn new() -> Zitadelmanagementv1GetCustomVerifyEmailOtpMessageTextResponse {
  ...
  pub fn with_custom_text(mut self, custom_text: models::V1MessageCustomText) -> Zitadelmanagementv1GetCustomVerifyEmailOtpMessageTextResponse {
    self.custom_text = Some(custom_text);
    self
  }
