...
pub struct Zitadelmanagementv1GetCustomInviteUserMessageTextResponse {
  #[serde(rename = "customText")]
  custom_text: Option<models::V1MessageCustomText>
}

impl Zitadelmanagementv1GetCustomInviteUserMessageTextResponse {
  pub fn new() -> Zitadelmanagementv1GetCustomInviteUserMessageTextResponse {
  ...
  pub fn with_custom_text(mut self, custom_text: models::V1MessageCustomText) -> Zitadelmanagementv1GetCustomInviteUserMessageTextResponse {
    self.custom_text = Some(custom_text);
    self
  }
