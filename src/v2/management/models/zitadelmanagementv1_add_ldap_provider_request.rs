...
pub struct Zitadelmanagementv1AddLdapProviderRequest {
  #[serde(rename = "name")]
  name: Option<String>,
...
impl Zitadelmanagementv1AddLdapProviderRequest {
  pub fn new() -> Zitadelmanagementv1AddLdapProviderRequest {
  ...
  pub fn with_name(mut self, name: String) -> Zitadelmanagementv1AddLdapProviderRequest {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_servers(mut self, servers: Vec<String>) -> Zitadelmanagementv1AddLdapProviderRequest {
    self.servers = Some(servers);
    self
  }
  ...
  pub fn with_start_tls(mut self, start_tls: bool) -> Zitadelmanagementv1AddLdapProviderRequest {
    self.start_tls = Some(start_tls);
    self
  }
  ...
  pub fn with_base_dn(mut self, base_dn: String) -> Zitadelmanagementv1AddLdapProviderRequest {
    self.base_dn = Some(base_dn);
    self
  }
  ...
  pub fn with_bind_dn(mut self, bind_dn: String) -> Zitadelmanagementv1AddLdapProviderRequest {
    self.bind_dn = Some(bind_dn);
    self
  }
  ...
  pub fn with_bind_password(mut self, bind_password: String) -> Zitadelmanagementv1AddLdapProviderRequest {
    self.bind_password = Some(bind_password);
    self
  }
  ...
  pub fn with_user_base(mut self, user_base: String) -> Zitadelmanagementv1AddLdapProviderRequest {
    self.user_base = Some(user_base);
    self
  }
  ...
  pub fn with_user_object_classes(mut self, user_object_classes: Vec<String>) -> Zitadelmanagementv1AddLdapProviderRequest {
    self.user_object_classes = Some(user_object_classes);
    self
  }
  ...
  pub fn with_user_filters(mut self, user_filters: Vec<String>) -> Zitadelmanagementv1AddLdapProviderRequest {
    self.user_filters = Some(user_filters);
    self
  }
  ...
  pub fn with_timeout(mut self, timeout: String) -> Zitadelmanagementv1AddLdapProviderRequest {
    self.timeout = Some(timeout);
    self
  }
  ...
  pub fn with_attributes(mut self, attributes: models::V1LdapAttributes) -> Zitadelmanagementv1AddLdapProviderRequest {
    self.attributes = Some(attributes);
    self
  }
  ...
  pub fn with_provider_options(mut self, provider_options: models::V1Options) -> Zitadelmanagementv1AddLdapProviderRequest {
    self.provider_options = Some(provider_options);
    self
  }
