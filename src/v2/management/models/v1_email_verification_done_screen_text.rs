...
impl V1EmailVerificationDoneScreenText {
  ...
  pub fn with_next_button_text(mut self, next_button_text: String) -> V1EmailVerificationDoneScreenText {
    self.next_button_text = Some(next_button_text);
    self
  }
  ...
  pub fn with_cancel_button_text(mut self, cancel_button_text: String) -> V1EmailVerificationDoneScreenText {
    self.cancel_button_text = Some(cancel_button_text);
    self
  }
  ...
  pub fn with_login_button_text(mut self, login_button_text: String) -> V1EmailVerificationDoneScreenText {
    self.login_button_text = Some(login_button_text);
    self
  }
