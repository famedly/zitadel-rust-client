...
pub struct V1ListAllProjectGrantsResponse {
...
impl V1ListAllProjectGrantsResponse {
  pub fn new() -> V1ListAllProjectGrantsResponse {
  ...
  pub fn with_details(mut self, details: models::V1ListDetails) -> V1ListAllProjectGrantsResponse {
    self.details = Some(details);
    self
  }
  ...
  pub fn with_result(mut self, result: Vec<models::V1GrantedProject>) -> V1ListAllProjectGrantsResponse {
    self.result = Some(result);
    self
  }
