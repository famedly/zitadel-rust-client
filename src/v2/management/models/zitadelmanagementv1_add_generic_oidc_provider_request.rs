...
pub struct Zitadelmanagementv1AddGenericOidcProviderRequest {
  #[serde(rename = "name")]
  name: Option<String>,
...
impl Zitadelmanagementv1AddGenericOidcProviderRequest {
  pub fn new() -> Zitadelmanagementv1AddGenericOidcProviderRequest {
  ...
  pub fn with_name(mut self, name: String) -> Zitadelmanagementv1AddGenericOidcProviderRequest {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_issuer(mut self, issuer: String) -> Zitadelmanagementv1AddGenericOidcProviderRequest {
    self.issuer = Some(issuer);
    self
  }
  ...
  pub fn with_client_id(mut self, client_id: String) -> Zitadelmanagementv1AddGenericOidcProviderRequest {
    self.client_id = Some(client_id);
    self
  }
  ...
  pub fn with_client_secret(mut self, client_secret: String) -> Zitadelmanagementv1AddGenericOidcProviderRequest {
    self.client_secret = Some(client_secret);
    self
  }
  ...
  pub fn with_scopes(mut self, scopes: Vec<String>) -> Zitadelmanagementv1AddGenericOidcProviderRequest {
    self.scopes = Some(scopes);
    self
  }
  ...
  pub fn with_provider_options(mut self, provider_options: models::V1Options) -> Zitadelmanagementv1AddGenericOidcProviderRequest {
    self.provider_options = Some(provider_options);
    self
  }
  ...
  pub fn with_is_id_token_mapping(mut self, is_id_token_mapping: bool) -> Zitadelmanagementv1AddGenericOidcProviderRequest {
    self.is_id_token_mapping = Some(is_id_token_mapping);
    self
  }
