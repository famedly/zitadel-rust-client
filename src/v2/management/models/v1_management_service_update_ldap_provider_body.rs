...
impl V1ManagementServiceUpdateLdapProviderBody {
  ...
  pub fn with_servers(mut self, servers: Vec<String>) -> V1ManagementServiceUpdateLdapProviderBody {
    self.servers = Some(servers);
    self
  }
  ...
  pub fn with_bind_password(mut self, bind_password: String) -> V1ManagementServiceUpdateLdapProviderBody {
    self.bind_password = Some(bind_password);
    self
  }
  ...
  pub fn with_user_base(mut self, user_base: String) -> V1ManagementServiceUpdateLdapProviderBody {
    self.user_base = Some(user_base);
    self
  }
  ...
  pub fn with_user_object_classes(mut self, user_object_classes: Vec<String>) -> V1ManagementServiceUpdateLdapProviderBody {
    self.user_object_classes = Some(user_object_classes);
    self
  }
  ...
  pub fn with_user_filters(mut self, user_filters: Vec<String>) -> V1ManagementServiceUpdateLdapProviderBody {
    self.user_filters = Some(user_filters);
    self
  }
  ...
  pub fn with_attributes(mut self, attributes: models::V1LdapAttributes) -> V1ManagementServiceUpdateLdapProviderBody {
    self.attributes = Some(attributes);
    self
  }
  ...
  pub fn with_provider_options(mut self, provider_options: models::V1Options) -> V1ManagementServiceUpdateLdapProviderBody {
    self.provider_options = Some(provider_options);
    self
  }
