...
pub struct V1AddCustomLoginPolicyRequest {
	...
	/// defines if unknown username on login screen directly returns an error or
	/// always displays the password screen
	#[serde(rename = "ignoreUnknownUsernames")]
	ignore_unknown_usernames: Option<bool>,
	/// defines where the user will be redirected to if the login is started
	/// without app context (e.g. from mail)
	...
	/// If set to true, the suffix (@domain.com) of an unknown username input on
	/// the login screen will be matched against the org domains and will
	/// redirect to the registration of that organization on success.
	#[serde(rename = "allowDomainDiscovery")]
	allow_domain_discovery: Option<bool>,
	/// defines if the user can additionally (to the login name) be identified
	/// by their verified email address
	#[serde(rename = "disableLoginWithEmail")]
	disable_login_with_email: Option<bool>,
	/// defines if the user can additionally (to the login name) be identified
	/// by their verified phone number
	#[serde(rename = "disableLoginWithPhone")]
	disable_login_with_phone: Option<bool>,
	/// if activated, only local authenticated users are forced to use MFA.
	/// Authentication through IDPs won't prompt a MFA step in the login.
...
impl V1AddCustomLoginPolicyRequest {
	...
	pub fn with_allow_username_password(
		mut self,
	...
	pub fn with_allow_external_idp(
		mut self,
	...
	pub fn with_passwordless_type(
		mut self,
		passwordless_type: models::V1PasswordlessType,
	) -> V1AddCustomLoginPolicyRequest {
		self.passwordless_type = Some(passwordless_type);
		self
	}
	...
	pub fn with_hide_password_reset(
		mut self,
	...
	pub fn with_ignore_unknown_usernames(
		mut self,
	...
	pub fn with_default_redirect_uri(
		mut self,
	...
	pub fn with_password_check_lifetime(
		mut self,
	...
	pub fn with_external_login_check_lifetime(
		mut self,
	...
	pub fn with_mfa_init_skip_lifetime(
		mut self,
	...
	pub fn with_second_factor_check_lifetime(
		mut self,
	...
	pub fn with_multi_factor_check_lifetime(
		mut self,
	...
	pub fn with_second_factors(
		mut self,
		second_factors: Vec<models::V1SecondFactorType>,
	) -> V1AddCustomLoginPolicyRequest {
		self.second_factors = Some(second_factors);
		self
	}
	...
	pub fn with_multi_factors(
		mut self,
		multi_factors: Vec<models::V1MultiFactorType>,
	) -> V1AddCustomLoginPolicyRequest {
		self.multi_factors = Some(multi_factors);
		self
	}
	...
	pub fn with_idps(
		mut self,
		idps: Vec<models::V1AddCustomLoginPolicyRequestIdp>,
	) -> V1AddCustomLoginPolicyRequest {
		self.idps = Some(idps);
		self
	}
	...
	pub fn with_allow_domain_discovery(
		mut self,
	...
	pub fn with_disable_login_with_email(
		mut self,
	...
	pub fn with_disable_login_with_phone(
		mut self,
	...
	pub fn with_force_mfa_local_only(
		mut self,
