...
pub struct V1AddCustomLoginPolicyRequest {
  ...
  #[serde(rename = "idps")]
  idps: Option<Vec<models::V1AddCustomLoginPolicyRequestIdp>>,
...
impl V1AddCustomLoginPolicyRequest {
  pub fn new() -> V1AddCustomLoginPolicyRequest {
  ...
  pub fn with_allow_username_password(mut self, allow_username_password: bool) -> V1AddCustomLoginPolicyRequest {
    self.allow_username_password = Some(allow_username_password);
    self
  }
  ...
  pub fn with_allow_register(mut self, allow_register: bool) -> V1AddCustomLoginPolicyRequest {
    self.allow_register = Some(allow_register);
    self
  }
  ...
  pub fn with_allow_external_idp(mut self, allow_external_idp: bool) -> V1AddCustomLoginPolicyRequest {
    self.allow_external_idp = Some(allow_external_idp);
    self
  }
  ...
  pub fn with_force_mfa(mut self, force_mfa: bool) -> V1AddCustomLoginPolicyRequest {
    self.force_mfa = Some(force_mfa);
    self
  }
  ...
  pub fn with_passwordless_type(mut self, passwordless_type: models::V1PasswordlessType) -> V1AddCustomLoginPolicyRequest {
    self.passwordless_type = Some(passwordless_type);
    self
  }
  ...
  pub fn with_hide_password_reset(mut self, hide_password_reset: bool) -> V1AddCustomLoginPolicyRequest {
    self.hide_password_reset = Some(hide_password_reset);
    self
  }
  ...
  pub fn with_ignore_unknown_usernames(mut self, ignore_unknown_usernames: bool) -> V1AddCustomLoginPolicyRequest {
    self.ignore_unknown_usernames = Some(ignore_unknown_usernames);
    self
  }
  ...
  pub fn with_default_redirect_uri(mut self, default_redirect_uri: String) -> V1AddCustomLoginPolicyRequest {
    self.default_redirect_uri = Some(default_redirect_uri);
    self
  }
  ...
  pub fn with_password_check_lifetime(mut self, password_check_lifetime: String) -> V1AddCustomLoginPolicyRequest {
    self.password_check_lifetime = Some(password_check_lifetime);
    self
  }
  ...
  pub fn with_external_login_check_lifetime(mut self, external_login_check_lifetime: String) -> V1AddCustomLoginPolicyRequest {
    self.external_login_check_lifetime = Some(external_login_check_lifetime);
    self
  }
  ...
  pub fn with_mfa_init_skip_lifetime(mut self, mfa_init_skip_lifetime: String) -> V1AddCustomLoginPolicyRequest {
    self.mfa_init_skip_lifetime = Some(mfa_init_skip_lifetime);
    self
  }
  ...
  pub fn with_second_factor_check_lifetime(mut self, second_factor_check_lifetime: String) -> V1AddCustomLoginPolicyRequest {
    self.second_factor_check_lifetime = Some(second_factor_check_lifetime);
    self
  }
  ...
  pub fn with_multi_factor_check_lifetime(mut self, multi_factor_check_lifetime: String) -> V1AddCustomLoginPolicyRequest {
    self.multi_factor_check_lifetime = Some(multi_factor_check_lifetime);
    self
  }
  ...
  pub fn with_second_factors(mut self, second_factors: Vec<models::V1SecondFactorType>) -> V1AddCustomLoginPolicyRequest {
    self.second_factors = Some(second_factors);
    self
  }
  ...
  pub fn with_multi_factors(mut self, multi_factors: Vec<models::V1MultiFactorType>) -> V1AddCustomLoginPolicyRequest {
    self.multi_factors = Some(multi_factors);
    self
  }
  ...
  pub fn set_idps(&mut self, idps: Vec<models::V1AddCustomLoginPolicyRequestIdp>) {
    self.idps = Some(idps);
  }

  pub fn with_idps(mut self, idps: Vec<models::V1AddCustomLoginPolicyRequestIdp>) -> V1AddCustomLoginPolicyRequest {
    self.idps = Some(idps);
    self
  }

  pub fn idps(&self) -> Option<&Vec<models::V1AddCustomLoginPolicyRequestIdp>> {
    self.idps.as_ref()
  }
  ...
  pub fn with_allow_domain_discovery(mut self, allow_domain_discovery: bool) -> V1AddCustomLoginPolicyRequest {
    self.allow_domain_discovery = Some(allow_domain_discovery);
    self
  }
  ...
  pub fn with_disable_login_with_email(mut self, disable_login_with_email: bool) -> V1AddCustomLoginPolicyRequest {
    self.disable_login_with_email = Some(disable_login_with_email);
    self
  }
  ...
  pub fn with_disable_login_with_phone(mut self, disable_login_with_phone: bool) -> V1AddCustomLoginPolicyRequest {
    self.disable_login_with_phone = Some(disable_login_with_phone);
    self
  }
  ...
  pub fn with_force_mfa_local_only(mut self, force_mfa_local_only: bool) -> V1AddCustomLoginPolicyRequest {
    self.force_mfa_local_only = Some(force_mfa_local_only);
    self
  }
