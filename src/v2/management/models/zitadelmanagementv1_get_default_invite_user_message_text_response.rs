...
pub struct Zitadelmanagementv1GetDefaultInviteUserMessageTextResponse {
  #[serde(rename = "customText")]
  custom_text: Option<models::V1MessageCustomText>
}

impl Zitadelmanagementv1GetDefaultInviteUserMessageTextResponse {
  pub fn new() -> Zitadelmanagementv1GetDefaultInviteUserMessageTextResponse {
  ...
  pub fn with_custom_text(mut self, custom_text: models::V1MessageCustomText) -> Zitadelmanagementv1GetDefaultInviteUserMessageTextResponse {
    self.custom_text = Some(custom_text);
    self
  }
