...
pub struct Zitadelmanagementv1GetCustomVerifySmsotpMessageTextResponse {
  #[serde(rename = "customText")]
  custom_text: Option<models::V1MessageCustomText>
}

impl Zitadelmanagementv1GetCustomVerifySmsotpMessageTextResponse {
  pub fn new() -> Zitadelmanagementv1GetCustomVerifySmsotpMessageTextResponse {
  ...
  pub fn with_custom_text(mut self, custom_text: models::V1MessageCustomText) -> Zitadelmanagementv1GetCustomVerifySmsotpMessageTextResponse {
    self.custom_text = Some(custom_text);
    self
  }
