...
impl V1PasswordChangeScreenText {
  ...
  pub fn with_old_password_label(mut self, old_password_label: String) -> V1PasswordChangeScreenText {
    self.old_password_label = Some(old_password_label);
    self
  }
  ...
  pub fn with_new_password_label(mut self, new_password_label: String) -> V1PasswordChangeScreenText {
    self.new_password_label = Some(new_password_label);
    self
  }
  ...
  pub fn with_new_password_confirm_label(mut self, new_password_confirm_label: String) -> V1PasswordChangeScreenText {
    self.new_password_confirm_label = Some(new_password_confirm_label);
    self
  }
  ...
  pub fn with_cancel_button_text(mut self, cancel_button_text: String) -> V1PasswordChangeScreenText {
    self.cancel_button_text = Some(cancel_button_text);
    self
  }
  ...
  pub fn with_expired_description(mut self, expired_description: String) -> V1PasswordChangeScreenText {
    self.expired_description = Some(expired_description);
    self
  }
