...
pub struct V1UpdateCustomLabelPolicyRequest {
...
impl V1UpdateCustomLabelPolicyRequest {
  pub fn new() -> V1UpdateCustomLabelPolicyRequest {
  ...
  pub fn with_primary_color(mut self, primary_color: String) -> V1UpdateCustomLabelPolicyRequest {
    self.primary_color = Some(primary_color);
    self
  }
  ...
  pub fn with_hide_login_name_suffix(mut self, hide_login_name_suffix: bool) -> V1UpdateCustomLabelPolicyRequest {
    self.hide_login_name_suffix = Some(hide_login_name_suffix);
    self
  }
  ...
  pub fn with_warn_color(mut self, warn_color: String) -> V1UpdateCustomLabelPolicyRequest {
    self.warn_color = Some(warn_color);
    self
  }
  ...
  pub fn with_background_color(mut self, background_color: String) -> V1UpdateCustomLabelPolicyRequest {
    self.background_color = Some(background_color);
    self
  }
  ...
  pub fn with_font_color(mut self, font_color: String) -> V1UpdateCustomLabelPolicyRequest {
    self.font_color = Some(font_color);
    self
  }
  ...
  pub fn with_primary_color_dark(mut self, primary_color_dark: String) -> V1UpdateCustomLabelPolicyRequest {
    self.primary_color_dark = Some(primary_color_dark);
    self
  }
  ...
  pub fn with_background_color_dark(mut self, background_color_dark: String) -> V1UpdateCustomLabelPolicyRequest {
    self.background_color_dark = Some(background_color_dark);
    self
  }
  ...
  pub fn with_warn_color_dark(mut self, warn_color_dark: String) -> V1UpdateCustomLabelPolicyRequest {
    self.warn_color_dark = Some(warn_color_dark);
    self
  }
  ...
  pub fn with_font_color_dark(mut self, font_color_dark: String) -> V1UpdateCustomLabelPolicyRequest {
    self.font_color_dark = Some(font_color_dark);
    self
  }
  ...
  pub fn with_disable_watermark(mut self, disable_watermark: bool) -> V1UpdateCustomLabelPolicyRequest {
    self.disable_watermark = Some(disable_watermark);
    self
  }
  ...
  pub fn with_theme_mode(mut self, theme_mode: models::V1ThemeMode) -> V1UpdateCustomLabelPolicyRequest {
    self.theme_mode = Some(theme_mode);
    self
  }
