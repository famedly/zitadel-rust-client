...
impl V1ActionQuery {
	pub fn new() -> V1ActionQuery {
		V1ActionQuery { action_id_query: None, action_name_query: None, action_state_query: None }
	}
	...
	pub fn with_action_id_query(
		mut self,
		action_id_query: models::V1ActionIdQuery,
	) -> V1ActionQuery {
		self.action_id_query = Some(action_id_query);
		self
	}
	...
	pub fn with_action_name_query(
		mut self,
		action_name_query: models::V1ActionNameQuery,
	) -> V1ActionQuery {
		self.action_name_query = Some(action_name_query);
		self
	}
	...
	pub fn with_action_state_query(
		mut self,
		action_state_query: models::V1ActionStateQuery,
	) -> V1ActionQuery {
		self.action_state_query = Some(action_state_query);
		self
	}
