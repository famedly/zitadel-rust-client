...
impl Zitadelmanagementv1AddGoogleProviderRequest {
  ...
  pub fn with_client_id(mut self, client_id: String) -> Zitadelmanagementv1AddGoogleProviderRequest {
    self.client_id = Some(client_id);
    self
  }
  ...
  pub fn with_client_secret(mut self, client_secret: String) -> Zitadelmanagementv1AddGoogleProviderRequest {
    self.client_secret = Some(client_secret);
    self
  }
  ...
  pub fn with_scopes(mut self, scopes: Vec<String>) -> Zitadelmanagementv1AddGoogleProviderRequest {
    self.scopes = Some(scopes);
    self
  }
  ...
  pub fn with_provider_options(mut self, provider_options: models::V1Options) -> Zitadelmanagementv1AddGoogleProviderRequest {
    self.provider_options = Some(provider_options);
    self
  }
