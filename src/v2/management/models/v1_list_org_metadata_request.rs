...
pub struct V1ListOrgMetadataRequest {
  #[serde(rename = "query")]
...
impl V1ListOrgMetadataRequest {
  pub fn new() -> V1ListOrgMetadataRequest {
  ...
  pub fn with_query(mut self, query: models::V1ListQuery) -> V1ListOrgMetadataRequest {
    self.query = Some(query);
    self
  }
  ...
  pub fn with_queries(mut self, queries: Vec<models::V1MetadataQuery>) -> V1ListOrgMetadataRequest {
    self.queries = Some(queries);
    self
  }
