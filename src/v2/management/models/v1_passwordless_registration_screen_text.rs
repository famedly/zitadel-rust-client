...
pub struct V1PasswordlessRegistrationScreenText {
  #[serde(rename = "title")]
  title: Option<String>,
...
impl V1PasswordlessRegistrationScreenText {
  pub fn new() -> V1PasswordlessRegistrationScreenText {
  ...
  pub fn with_title(mut self, title: String) -> V1PasswordlessRegistrationScreenText {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> V1PasswordlessRegistrationScreenText {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_token_name_label(mut self, token_name_label: String) -> V1PasswordlessRegistrationScreenText {
    self.token_name_label = Some(token_name_label);
    self
  }
  ...
  pub fn with_not_supported(mut self, not_supported: String) -> V1PasswordlessRegistrationScreenText {
    self.not_supported = Some(not_supported);
    self
  }
  ...
  pub fn with_register_token_button_text(mut self, register_token_button_text: String) -> V1PasswordlessRegistrationScreenText {
    self.register_token_button_text = Some(register_token_button_text);
    self
  }
  ...
  pub fn with_error_retry(mut self, error_retry: String) -> V1PasswordlessRegistrationScreenText {
    self.error_retry = Some(error_retry);
    self
  }
