...
pub struct Zitadelappv1SamlConfig {
...
impl Zitadelappv1SamlConfig {
	pub fn new() -> Zitadelappv1SamlConfig {
		Zitadelappv1SamlConfig { metadata_xml: None, metadata_url: None }
	}
	...
	pub fn with_metadata_xml(mut self, metadata_xml: String) -> Zitadelappv1SamlConfig {
		self.metadata_xml = Some(metadata_xml);
		self
	}
	...
	pub fn with_metadata_url(mut self, metadata_url: String) -> Zitadelappv1SamlConfig {
		self.metadata_url = Some(metadata_url);
		self
	}
