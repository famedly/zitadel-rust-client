...
impl V1UserGrantQuery {
	...
	pub fn with_with_granted_query(
		mut self,
		with_granted_query: models::V1UserGrantWithGrantedQuery,
	) -> V1UserGrantQuery {
		self.with_granted_query = Some(with_granted_query);
	...
	pub fn set_project_grant_id_query(
		&mut self,
	...
	pub fn with_project_grant_id_query(
		mut self,
		project_grant_id_query: models::V1UserGrantProjectGrantIdQuery,
	) -> V1UserGrantQuery {
		self.project_grant_id_query = Some(project_grant_id_query);
