...
impl V1LinkingUserDoneScreenText {
  ...
  pub fn with_cancel_button_text(mut self, cancel_button_text: String) -> V1LinkingUserDoneScreenText {
    self.cancel_button_text = Some(cancel_button_text);
    self
  }
  ...
  pub fn with_next_button_text(mut self, next_button_text: String) -> V1LinkingUserDoneScreenText {
    self.next_button_text = Some(next_button_text);
    self
  }
