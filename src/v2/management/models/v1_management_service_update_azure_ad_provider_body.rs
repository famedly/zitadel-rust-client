...
pub struct V1ManagementServiceUpdateAzureAdProviderBody {
  #[serde(rename = "name")]
  name: Option<String>,
...
impl V1ManagementServiceUpdateAzureAdProviderBody {
  pub fn new() -> V1ManagementServiceUpdateAzureAdProviderBody {
  ...
  pub fn with_name(mut self, name: String) -> V1ManagementServiceUpdateAzureAdProviderBody {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_client_id(mut self, client_id: String) -> V1ManagementServiceUpdateAzureAdProviderBody {
    self.client_id = Some(client_id);
    self
  }
  ...
  pub fn with_client_secret(mut self, client_secret: String) -> V1ManagementServiceUpdateAzureAdProviderBody {
    self.client_secret = Some(client_secret);
    self
  }
  ...
  pub fn with_tenant(mut self, tenant: models::V1AzureAdTenant) -> V1ManagementServiceUpdateAzureAdProviderBody {
    self.tenant = Some(tenant);
    self
  }
  ...
  pub fn with_email_verified(mut self, email_verified: bool) -> V1ManagementServiceUpdateAzureAdProviderBody {
    self.email_verified = Some(email_verified);
    self
  }
  ...
  pub fn with_scopes(mut self, scopes: Vec<String>) -> V1ManagementServiceUpdateAzureAdProviderBody {
    self.scopes = Some(scopes);
    self
  }
  ...
  pub fn with_provider_options(mut self, provider_options: models::V1Options) -> V1ManagementServiceUpdateAzureAdProviderBody {
    self.provider_options = Some(provider_options);
    self
  }
