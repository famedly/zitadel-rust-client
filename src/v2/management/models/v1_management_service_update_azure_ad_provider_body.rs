...
pub struct V1ManagementServiceUpdateAzureAdProviderBody {
	...
	/// Defines what kind of accounts are allowed to authenticate (Personal,
	/// Organizational, All). If not provided the `common` tenant will be used
	/// (All accounts)
	#[serde(rename = "tenant")]
