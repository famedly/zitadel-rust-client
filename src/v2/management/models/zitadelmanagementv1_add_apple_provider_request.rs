...
impl Zitadelmanagementv1AddAppleProviderRequest {
  pub fn new(client_id: String, team_id: String, key_id: String, private_key: String) -> Zitadelmanagementv1AddAppleProviderRequest {
  ...
  pub fn with_client_id(mut self, client_id: String) -> Zitadelmanagementv1AddAppleProviderRequest {
    self.client_id = client_id;
    self
  }
  ...
  pub fn with_private_key(mut self, private_key: String) -> Zitadelmanagementv1AddAppleProviderRequest {
    self.private_key = private_key;
    self
  }
  ...
  pub fn with_scopes(mut self, scopes: Vec<String>) -> Zitadelmanagementv1AddAppleProviderRequest {
    self.scopes = Some(scopes);
    self
  }
  ...
  pub fn with_provider_options(mut self, provider_options: models::V1Options) -> Zitadelmanagementv1AddAppleProviderRequest {
    self.provider_options = Some(provider_options);
    self
  }
