...
impl V1UpdateCustomPrivacyPolicyRequest {
  ...
  pub fn with_support_email(mut self, support_email: String) -> V1UpdateCustomPrivacyPolicyRequest {
    self.support_email = Some(support_email);
    self
  }
  ...
  pub fn with_custom_link_text(mut self, custom_link_text: String) -> V1UpdateCustomPrivacyPolicyRequest {
    self.custom_link_text = Some(custom_link_text);
    self
  }
