...
pub struct V1UpdateCustomPrivacyPolicyRequest {
...
impl V1UpdateCustomPrivacyPolicyRequest {
	pub fn new() -> V1UpdateCustomPrivacyPolicyRequest {
	...
	pub fn with_tos_link(mut self, tos_link: String) -> V1UpdateCustomPrivacyPolicyRequest {
		self.tos_link = Some(tos_link);
		self
	}
	...
	pub fn with_privacy_link(mut self, privacy_link: String) -> V1UpdateCustomPrivacyPolicyRequest {
		self.privacy_link = Some(privacy_link);
		self
	}
	...
	pub fn with_help_link(mut self, help_link: String) -> V1UpdateCustomPrivacyPolicyRequest {
		self.help_link = Some(help_link);
		self
	}
	...
	pub fn with_docs_link(mut self, docs_link: String) -> V1UpdateCustomPrivacyPolicyRequest {
		self.docs_link = Some(docs_link);
		self
	}
	...
	pub fn with_custom_link(mut self, custom_link: String) -> V1UpdateCustomPrivacyPolicyRequest {
		self.custom_link = Some(custom_link);
		self
	}
