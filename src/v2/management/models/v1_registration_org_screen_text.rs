...
impl V1RegistrationOrgScreenText {
  ...
  pub fn with_password_confirm_label(mut self, password_confirm_label: String) -> V1RegistrationOrgScreenText {
    self.password_confirm_label = Some(password_confirm_label);
    self
  }
  ...
  pub fn with_tos_and_privacy_label(mut self, tos_and_privacy_label: String) -> V1RegistrationOrgScreenText {
    self.tos_and_privacy_label = Some(tos_and_privacy_label);
    self
  }
  ...
  pub fn with_privacy_link_text(mut self, privacy_link_text: String) -> V1RegistrationOrgScreenText {
    self.privacy_link_text = Some(privacy_link_text);
    self
  }
  ...
  pub fn with_save_button_text(mut self, save_button_text: String) -> V1RegistrationOrgScreenText {
    self.save_button_text = Some(save_button_text);
    self
  }
