...
impl ImportHumanUserResponsePasswordlessRegistration {
  ...
  pub fn with_lifetime(mut self, lifetime: String) -> ImportHumanUserResponsePasswordlessRegistration {
    self.lifetime = Some(lifetime);
    self
  }
  ...
  pub fn with_expiration(mut self, expiration: String) -> ImportHumanUserResponsePasswordlessRegistration {
    self.expiration = Some(expiration);
    self
  }
