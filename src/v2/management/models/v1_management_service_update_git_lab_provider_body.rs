...
pub struct V1ManagementServiceUpdateGitLabProviderBody {
...
impl V1ManagementServiceUpdateGitLabProviderBody {
  pub fn new() -> V1ManagementServiceUpdateGitLabProviderBody {
  ...
  pub fn with_name(mut self, name: String) -> V1ManagementServiceUpdateGitLabProviderBody {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_client_id(mut self, client_id: String) -> V1ManagementServiceUpdateGitLabProviderBody {
    self.client_id = Some(client_id);
    self
  }
  ...
  pub fn with_client_secret(mut self, client_secret: String) -> V1ManagementServiceUpdateGitLabProviderBody {
    self.client_secret = Some(client_secret);
    self
  }
  ...
  pub fn with_scopes(mut self, scopes: Vec<String>) -> V1ManagementServiceUpdateGitLabProviderBody {
    self.scopes = Some(scopes);
    self
  }
  ...
  pub fn with_provider_options(mut self, provider_options: models::V1Options) -> V1ManagementServiceUpdateGitLabProviderBody {
    self.provider_options = Some(provider_options);
    self
  }
