...
impl Zitadelidpv1OidcConfig {
  ...
  pub fn with_display_name_mapping(mut self, display_name_mapping: models::V1OidcMappingField) -> Zitadelidpv1OidcConfig {
    self.display_name_mapping = Some(display_name_mapping);
    self
  }
  ...
  pub fn with_username_mapping(mut self, username_mapping: models::V1OidcMappingField) -> Zitadelidpv1OidcConfig {
    self.username_mapping = Some(username_mapping);
    self
  }
