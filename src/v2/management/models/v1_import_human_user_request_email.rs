...
pub struct V1ImportHumanUserRequestEmail {
	...
	#[serde(rename = "email")]
	email: String,
	/// If email verified is set to true, the email will be added as verified
	/// and the user doesn't have to verify.
...
impl V1ImportHumanUserRequestEmail {
	pub fn new(email: String) -> V1ImportHumanUserRequestEmail {
		V1ImportHumanUserRequestEmail { email: email, is_email_verified: None }
	}
