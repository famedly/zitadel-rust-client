...
impl V1ManagementServiceUpdateGitHubEnterpriseServerProviderBody {
  ...
  pub fn with_name(mut self, name: String) -> V1ManagementServiceUpdateGitHubEnterpriseServerProviderBody {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_client_id(mut self, client_id: String) -> V1ManagementServiceUpdateGitHubEnterpriseServerProviderBody {
    self.client_id = Some(client_id);
    self
  }
  ...
  pub fn with_client_secret(mut self, client_secret: String) -> V1ManagementServiceUpdateGitHubEnterpriseServerProviderBody {
    self.client_secret = Some(client_secret);
    self
  }
  ...
  pub fn with_authorization_endpoint(mut self, authorization_endpoint: String) -> V1ManagementServiceUpdateGitHubEnterpriseServerProviderBody {
    self.authorization_endpoint = Some(authorization_endpoint);
    self
  }
  ...
  pub fn with_token_endpoint(mut self, token_endpoint: String) -> V1ManagementServiceUpdateGitHubEnterpriseServerProviderBody {
    self.token_endpoint = Some(token_endpoint);
    self
  }
  ...
  pub fn with_user_endpoint(mut self, user_endpoint: String) -> V1ManagementServiceUpdateGitHubEnterpriseServerProviderBody {
    self.user_endpoint = Some(user_endpoint);
    self
  }
  ...
  pub fn with_scopes(mut self, scopes: Vec<String>) -> V1ManagementServiceUpdateGitHubEnterpriseServerProviderBody {
    self.scopes = Some(scopes);
    self
  }
  ...
  pub fn with_provider_options(mut self, provider_options: models::V1Options) -> V1ManagementServiceUpdateGitHubEnterpriseServerProviderBody {
    self.provider_options = Some(provider_options);
    self
  }
