...
impl V1ProviderConfig {
  ...
  pub fn with_github_es(mut self, github_es: models::V1GitHubEnterpriseServerConfig) -> V1ProviderConfig {
    self.github_es = Some(github_es);
    self
  }
  ...
  pub fn with_gitlab_self_hosted(mut self, gitlab_self_hosted: models::V1GitLabSelfHostedConfig) -> V1ProviderConfig {
    self.gitlab_self_hosted = Some(gitlab_self_hosted);
    self
  }
