...
impl V1SelectAccountScreenText {
  ...
  pub fn with_title_linking_process(mut self, title_linking_process: String) -> V1SelectAccountScreenText {
    self.title_linking_process = Some(title_linking_process);
    self
  }
  ...
  pub fn with_description_linking_process(mut self, description_linking_process: String) -> V1SelectAccountScreenText {
    self.description_linking_process = Some(description_linking_process);
    self
  }
  ...
  pub fn with_session_state_active(mut self, session_state_active: String) -> V1SelectAccountScreenText {
    self.session_state_active = Some(session_state_active);
    self
  }
  ...
  pub fn with_session_state_inactive(mut self, session_state_inactive: String) -> V1SelectAccountScreenText {
    self.session_state_inactive = Some(session_state_inactive);
    self
  }
  ...
  pub fn with_user_must_be_member_of_org(mut self, user_must_be_member_of_org: String) -> V1SelectAccountScreenText {
    self.user_must_be_member_of_org = Some(user_must_be_member_of_org);
    self
  }
