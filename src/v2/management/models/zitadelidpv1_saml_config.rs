...
impl Zitadelidpv1SamlConfig {
  ...
  pub fn with_name_id_format(mut self, name_id_format: models::V1SamlNameIdFormat) -> Zitadelidpv1SamlConfig {
    self.name_id_format = Some(name_id_format);
    self
  }
  ...
  pub fn with_transient_mapping_attribute_name(mut self, transient_mapping_attribute_name: String) -> Zitadelidpv1SamlConfig {
    self.transient_mapping_attribute_name = Some(transient_mapping_attribute_name);
    self
  }
