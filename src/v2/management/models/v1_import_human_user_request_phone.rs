...
/// V1ImportHumanUserRequestPhone : Object that contains the number and a verified flag
...
impl V1ImportHumanUserRequestPhone {
  ...
  pub fn with_is_phone_verified(mut self, is_phone_verified: bool) -> V1ImportHumanUserRequestPhone {
    self.is_phone_verified = Some(is_phone_verified);
    self
  }
