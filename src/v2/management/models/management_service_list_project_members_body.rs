...
pub struct ManagementServiceListProjectMembersBody {
  #[serde(rename = "query")]
...
impl ManagementServiceListProjectMembersBody {
  pub fn new() -> ManagementServiceListProjectMembersBody {
  ...
  pub fn with_query(mut self, query: models::V1ListQuery) -> ManagementServiceListProjectMembersBody {
    self.query = Some(query);
    self
  }
  ...
  pub fn with_queries(mut self, queries: Vec<models::Zitadelmemberv1SearchQuery>) -> ManagementServiceListProjectMembersBody {
    self.queries = Some(queries);
    self
  }
