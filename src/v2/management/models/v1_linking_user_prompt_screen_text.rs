...
impl V1LinkingUserPromptScreenText {
  ...
  pub fn with_link_button_text(mut self, link_button_text: String) -> V1LinkingUserPromptScreenText {
    self.link_button_text = Some(link_button_text);
    self
  }
  ...
  pub fn with_other_button_text(mut self, other_button_text: String) -> V1LinkingUserPromptScreenText {
    self.other_button_text = Some(other_button_text);
    self
  }
