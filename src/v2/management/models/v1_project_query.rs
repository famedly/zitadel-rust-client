...
impl V1ProjectQuery {
	pub fn new() -> V1ProjectQuery {
		V1ProjectQuery { name_query: None, project_resource_owner_query: None }
	}
	...
	pub fn set_project_resource_owner_query(
		&mut self,
		project_resource_owner_query: models::V1ProjectResourceOwnerQuery,
	) {
		self.project_resource_owner_query = Some(project_resource_owner_query);
	}

	pub fn with_project_resource_owner_query(
		mut self,
		project_resource_owner_query: models::V1ProjectResourceOwnerQuery,
	) -> V1ProjectQuery {
		self.project_resource_owner_query = Some(project_resource_owner_query);
