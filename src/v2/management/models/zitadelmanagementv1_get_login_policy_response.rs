...
pub struct Zitadelmanagementv1GetLoginPolicyResponse {
  #[serde(rename = "policy")]
...
impl Zitadelmanagementv1GetLoginPolicyResponse {
  pub fn new() -> Zitadelmanagementv1GetLoginPolicyResponse {
  ...
  pub fn with_policy(mut self, policy: models::V1LoginPolicy) -> Zitadelmanagementv1GetLoginPolicyResponse {
    self.policy = Some(policy);
    self
  }
  ...
  pub fn with_is_default(mut self, is_default: bool) -> Zitadelmanagementv1GetLoginPolicyResponse {
    self.is_default = Some(is_default);
    self
  }
