...
pub struct Zitadelmanagementv1GetDefaultVerifyPhoneMessageTextResponse {
  #[serde(rename = "customText")]
  custom_text: Option<models::V1MessageCustomText>
}

impl Zitadelmanagementv1GetDefaultVerifyPhoneMessageTextResponse {
  pub fn new() -> Zitadelmanagementv1GetDefaultVerifyPhoneMessageTextResponse {
  ...
  pub fn with_custom_text(mut self, custom_text: models::V1MessageCustomText) -> Zitadelmanagementv1GetDefaultVerifyPhoneMessageTextResponse {
    self.custom_text = Some(custom_text);
    self
  }
