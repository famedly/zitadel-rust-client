...
impl V1AddHumanUserRequest {
  ...
  pub fn with_profile(mut self, profile: models::V1AddHumanUserRequestProfile) -> V1AddHumanUserRequest {
    self.profile = Some(profile);
    self
  }
  ...
  pub fn with_email(mut self, email: models::V1AddHumanUserRequestEmail) -> V1AddHumanUserRequest {
    self.email = Some(email);
    self
  }
  ...
  pub fn with_phone(mut self, phone: models::V1AddHumanUserRequestPhone) -> V1AddHumanUserRequest {
    self.phone = Some(phone);
    self
  }
