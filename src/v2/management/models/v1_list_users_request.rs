...
impl V1ListUsersRequest {
  ...
  pub fn with_sorting_column(mut self, sorting_column: models::V1UserFieldName) -> V1ListUsersRequest {
    self.sorting_column = Some(sorting_column);
    self
  }
  ...
  pub fn with_queries(mut self, queries: Vec<models::Zitadeluserv1SearchQuery>) -> V1ListUsersRequest {
    self.queries = Some(queries);
    self
  }
