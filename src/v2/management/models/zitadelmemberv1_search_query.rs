...
impl Zitadelmemberv1SearchQuery {
	...
	pub fn set_first_name_query(
		&mut self,
		first_name_query: models::Zitadelmemberv1FirstNameQuery,
	) {
	...
	pub fn with_last_name_query(
		mut self,
		last_name_query: models::Zitadelmemberv1LastNameQuery,
	) -> Zitadelmemberv1SearchQuery {
		self.last_name_query = Some(last_name_query);
		self
	}
	...
	pub fn with_email_query(
		mut self,
		email_query: models::Zitadelmemberv1EmailQuery,
	) -> Zitadelmemberv1SearchQuery {
		self.email_query = Some(email_query);
		self
	}
	...
	pub fn with_user_id_query(
		mut self,
		user_id_query: models::V1UserIdQuery,
	) -> Zitadelmemberv1SearchQuery {
		self.user_id_query = Some(user_id_query);
		self
	}
