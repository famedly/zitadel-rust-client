...
impl Zitadelmanagementv1GetPasswordComplexityPolicyResponse {
  ...
  pub fn with_policy(mut self, policy: models::V1PasswordComplexityPolicy) -> Zitadelmanagementv1GetPasswordComplexityPolicyResponse {
    self.policy = Some(policy);
    self
  }
  ...
  pub fn with_is_default(mut self, is_default: bool) -> Zitadelmanagementv1GetPasswordComplexityPolicyResponse {
    self.is_default = Some(is_default);
    self
  }
