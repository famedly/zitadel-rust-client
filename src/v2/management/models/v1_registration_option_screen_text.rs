...
impl V1RegistrationOptionScreenText {
  ...
  pub fn with_user_name_button_text(mut self, user_name_button_text: String) -> V1RegistrationOptionScreenText {
    self.user_name_button_text = Some(user_name_button_text);
    self
  }
  ...
  pub fn with_external_login_description(mut self, external_login_description: String) -> V1RegistrationOptionScreenText {
    self.external_login_description = Some(external_login_description);
    self
  }
  ...
  pub fn with_login_button_text(mut self, login_button_text: String) -> V1RegistrationOptionScreenText {
    self.login_button_text = Some(login_button_text);
    self
  }
