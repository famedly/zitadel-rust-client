...
impl V1ManagementServiceUpdateAppleProviderBody {
  pub fn new(client_id: String, team_id: String, key_id: String) -> V1ManagementServiceUpdateAppleProviderBody {
  ...
  pub fn with_client_id(mut self, client_id: String) -> V1ManagementServiceUpdateAppleProviderBody {
    self.client_id = client_id;
    self
  }
  ...
  pub fn with_private_key(mut self, private_key: String) -> V1ManagementServiceUpdateAppleProviderBody {
    self.private_key = Some(private_key);
    self
  }
  ...
  pub fn with_scopes(mut self, scopes: Vec<String>) -> V1ManagementServiceUpdateAppleProviderBody {
    self.scopes = Some(scopes);
    self
  }
  ...
  pub fn with_provider_options(mut self, provider_options: models::V1Options) -> V1ManagementServiceUpdateAppleProviderBody {
    self.provider_options = Some(provider_options);
    self
  }
