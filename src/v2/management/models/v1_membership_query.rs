...
impl V1MembershipQuery {
	...
	pub fn with_project_query(
		mut self,
		project_query: models::V1MembershipProjectQuery,
	) -> V1MembershipQuery {
		self.project_query = Some(project_query);
		self
	}
	...
	pub fn set_project_grant_query(
		&mut self,
		project_grant_query: models::V1MembershipProjectGrantQuery,
	) {
		self.project_grant_query = Some(project_grant_query);
	}

	pub fn with_project_grant_query(
		mut self,
		project_grant_query: models::V1MembershipProjectGrantQuery,
	) -> V1MembershipQuery {
		self.project_grant_query = Some(project_grant_query);
