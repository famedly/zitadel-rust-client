...
pub struct ManagementServiceAddOidcAppBody {
  #[serde(rename = "name")]
  name: String,
...
impl ManagementServiceAddOidcAppBody {
  pub fn new(name: String) -> ManagementServiceAddOidcAppBody {
  ...
  pub fn with_name(mut self, name: String) -> ManagementServiceAddOidcAppBody {
    self.name = name;
    self
  }
  ...
  pub fn with_redirect_uris(mut self, redirect_uris: Vec<String>) -> ManagementServiceAddOidcAppBody {
    self.redirect_uris = Some(redirect_uris);
    self
  }
  ...
  pub fn with_response_types(mut self, response_types: Vec<models::V1OidcResponseType>) -> ManagementServiceAddOidcAppBody {
    self.response_types = Some(response_types);
    self
  }
  ...
  pub fn with_grant_types(mut self, grant_types: Vec<models::V1OidcGrantType>) -> ManagementServiceAddOidcAppBody {
    self.grant_types = Some(grant_types);
    self
  }
  ...
  pub fn with_app_type(mut self, app_type: models::V1OidcAppType) -> ManagementServiceAddOidcAppBody {
    self.app_type = Some(app_type);
    self
  }
  ...
  pub fn with_auth_method_type(mut self, auth_method_type: models::V1OidcAuthMethodType) -> ManagementServiceAddOidcAppBody {
    self.auth_method_type = Some(auth_method_type);
    self
  }
  ...
  pub fn with_post_logout_redirect_uris(mut self, post_logout_redirect_uris: Vec<String>) -> ManagementServiceAddOidcAppBody {
    self.post_logout_redirect_uris = Some(post_logout_redirect_uris);
    self
  }
  ...
  pub fn with_version(mut self, version: models::V1OidcVersion) -> ManagementServiceAddOidcAppBody {
    self.version = Some(version);
    self
  }
  ...
  pub fn with_dev_mode(mut self, dev_mode: bool) -> ManagementServiceAddOidcAppBody {
    self.dev_mode = Some(dev_mode);
    self
  }
  ...
  pub fn with_access_token_type(mut self, access_token_type: models::V1OidcTokenType) -> ManagementServiceAddOidcAppBody {
    self.access_token_type = Some(access_token_type);
    self
  }
  ...
  pub fn with_access_token_role_assertion(mut self, access_token_role_assertion: bool) -> ManagementServiceAddOidcAppBody {
    self.access_token_role_assertion = Some(access_token_role_assertion);
    self
  }
  ...
  pub fn with_id_token_role_assertion(mut self, id_token_role_assertion: bool) -> ManagementServiceAddOidcAppBody {
    self.id_token_role_assertion = Some(id_token_role_assertion);
    self
  }
  ...
  pub fn with_id_token_userinfo_assertion(mut self, id_token_userinfo_assertion: bool) -> ManagementServiceAddOidcAppBody {
    self.id_token_userinfo_assertion = Some(id_token_userinfo_assertion);
    self
  }
  ...
  pub fn with_clock_skew(mut self, clock_skew: String) -> ManagementServiceAddOidcAppBody {
    self.clock_skew = Some(clock_skew);
    self
  }
  ...
  pub fn with_additional_origins(mut self, additional_origins: Vec<String>) -> ManagementServiceAddOidcAppBody {
    self.additional_origins = Some(additional_origins);
    self
  }
  ...
  pub fn with_skip_native_app_success_page(mut self, skip_native_app_success_page: bool) -> ManagementServiceAddOidcAppBody {
    self.skip_native_app_success_page = Some(skip_native_app_success_page);
    self
  }
  ...
  pub fn with_back_channel_logout_uri(mut self, back_channel_logout_uri: String) -> ManagementServiceAddOidcAppBody {
    self.back_channel_logout_uri = Some(back_channel_logout_uri);
    self
  }
  ...
  pub fn with_login_version(mut self, login_version: models::V1LoginVersion) -> ManagementServiceAddOidcAppBody {
    self.login_version = Some(login_version);
    self
  }
