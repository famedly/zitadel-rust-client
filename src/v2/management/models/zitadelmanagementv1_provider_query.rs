...
pub struct Zitadelmanagementv1ProviderQuery {
...
impl Zitadelmanagementv1ProviderQuery {
  pub fn new() -> Zitadelmanagementv1ProviderQuery {
  ...
  pub fn with_idp_id_query(mut self, idp_id_query: models::V1IdpidQuery) -> Zitadelmanagementv1ProviderQuery {
    self.idp_id_query = Some(idp_id_query);
    self
  }
  ...
  pub fn with_idp_name_query(mut self, idp_name_query: models::V1IdpNameQuery) -> Zitadelmanagementv1ProviderQuery {
    self.idp_name_query = Some(idp_name_query);
    self
  }
  ...
  pub fn with_owner_type_query(mut self, owner_type_query: models::V1IdpOwnerTypeQuery) -> Zitadelmanagementv1ProviderQuery {
    self.owner_type_query = Some(owner_type_query);
    self
  }
