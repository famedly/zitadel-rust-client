...
impl V1AllProjectGrantQuery {
  ...
  pub fn with_project_name_query(mut self, project_name_query: models::V1GrantProjectNameQuery) -> V1AllProjectGrantQuery {
    self.project_name_query = Some(project_name_query);
    self
  }
  ...
  pub fn with_role_key_query(mut self, role_key_query: models::V1GrantRoleKeyQuery) -> V1AllProjectGrantQuery {
    self.role_key_query = Some(role_key_query);
    self
  }
  ...
  pub fn with_project_id_query(mut self, project_id_query: models::V1ProjectIdQuery) -> V1AllProjectGrantQuery {
    self.project_id_query = Some(project_id_query);
    self
  }
  ...
  pub fn with_granted_org_id_query(mut self, granted_org_id_query: models::V1GrantedOrgIdQuery) -> V1AllProjectGrantQuery {
    self.granted_org_id_query = Some(granted_org_id_query);
    self
  }
