...
pub struct Zitadelmanagementv1AddGenericOAuthProviderRequest {
  #[serde(rename = "name")]
  name: Option<String>,
...
impl Zitadelmanagementv1AddGenericOAuthProviderRequest {
  pub fn new() -> Zitadelmanagementv1AddGenericOAuthProviderRequest {
  ...
  pub fn with_name(mut self, name: String) -> Zitadelmanagementv1AddGenericOAuthProviderRequest {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_client_id(mut self, client_id: String) -> Zitadelmanagementv1AddGenericOAuthProviderRequest {
    self.client_id = Some(client_id);
    self
  }
  ...
  pub fn with_client_secret(mut self, client_secret: String) -> Zitadelmanagementv1AddGenericOAuthProviderRequest {
    self.client_secret = Some(client_secret);
    self
  }
  ...
  pub fn with_authorization_endpoint(mut self, authorization_endpoint: String) -> Zitadelmanagementv1AddGenericOAuthProviderRequest {
    self.authorization_endpoint = Some(authorization_endpoint);
    self
  }
  ...
  pub fn with_token_endpoint(mut self, token_endpoint: String) -> Zitadelmanagementv1AddGenericOAuthProviderRequest {
    self.token_endpoint = Some(token_endpoint);
    self
  }
  ...
  pub fn with_user_endpoint(mut self, user_endpoint: String) -> Zitadelmanagementv1AddGenericOAuthProviderRequest {
    self.user_endpoint = Some(user_endpoint);
    self
  }
  ...
  pub fn with_scopes(mut self, scopes: Vec<String>) -> Zitadelmanagementv1AddGenericOAuthProviderRequest {
    self.scopes = Some(scopes);
    self
  }
  ...
  pub fn with_id_attribute(mut self, id_attribute: String) -> Zitadelmanagementv1AddGenericOAuthProviderRequest {
    self.id_attribute = Some(id_attribute);
    self
  }
  ...
  pub fn with_provider_options(mut self, provider_options: models::V1Options) -> Zitadelmanagementv1AddGenericOAuthProviderRequest {
    self.provider_options = Some(provider_options);
    self
  }
