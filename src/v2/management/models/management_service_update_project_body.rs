...
impl ManagementServiceUpdateProjectBody {
  ...
  pub fn with_project_role_assertion(mut self, project_role_assertion: bool) -> ManagementServiceUpdateProjectBody {
    self.project_role_assertion = Some(project_role_assertion);
    self
  }
  ...
  pub fn with_project_role_check(mut self, project_role_check: bool) -> ManagementServiceUpdateProjectBody {
    self.project_role_check = Some(project_role_check);
    self
  }
  ...
  pub fn with_has_project_check(mut self, has_project_check: bool) -> ManagementServiceUpdateProjectBody {
    self.has_project_check = Some(has_project_check);
    self
  }
  ...
  pub fn with_private_labeling_setting(mut self, private_labeling_setting: models::V1PrivateLabelingSetting) -> ManagementServiceUpdateProjectBody {
    self.private_labeling_setting = Some(private_labeling_setting);
    self
  }
