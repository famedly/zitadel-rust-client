...
impl V1ManagementServiceUpdateGoogleProviderBody {
  ...
  pub fn with_client_id(mut self, client_id: String) -> V1ManagementServiceUpdateGoogleProviderBody {
    self.client_id = Some(client_id);
    self
  }
  ...
  pub fn with_client_secret(mut self, client_secret: String) -> V1ManagementServiceUpdateGoogleProviderBody {
    self.client_secret = Some(client_secret);
    self
  }
  ...
  pub fn with_scopes(mut self, scopes: Vec<String>) -> V1ManagementServiceUpdateGoogleProviderBody {
    self.scopes = Some(scopes);
    self
  }
  ...
  pub fn with_provider_options(mut self, provider_options: models::V1Options) -> V1ManagementServiceUpdateGoogleProviderBody {
    self.provider_options = Some(provider_options);
    self
  }
