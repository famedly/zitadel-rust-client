...
pub struct Zitadelmanagementv1GetCustomVerifyEmailMessageTextResponse {
  #[serde(rename = "customText")]
  custom_text: Option<models::V1MessageCustomText>
}

impl Zitadelmanagementv1GetCustomVerifyEmailMessageTextResponse {
  pub fn new() -> Zitadelmanagementv1GetCustomVerifyEmailMessageTextResponse {
  ...
  pub fn with_custom_text(mut self, custom_text: models::V1MessageCustomText) -> Zitadelmanagementv1GetCustomVerifyEmailMessageTextResponse {
    self.custom_text = Some(custom_text);
    self
  }
