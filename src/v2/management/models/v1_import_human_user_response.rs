...
impl V1ImportHumanUserResponse {
  pub fn new() -> V1ImportHumanUserResponse {
    V1ImportHumanUserResponse {
      user_id: None,
      details: None,
      passwordless_registration: None
    }
  }
  ...
  pub fn set_passwordless_registration(&mut self, passwordless_registration: models::ImportHumanUserResponsePasswordlessRegistration) {
    self.passwordless_registration = Some(passwordless_registration);
  }

  pub fn with_passwordless_registration(mut self, passwordless_registration: models::ImportHumanUserResponsePasswordlessRegistration) -> V1ImportHumanUserResponse {
    self.passwordless_registration = Some(passwordless_registration);
    self
  }

  pub fn passwordless_registration(&self) -> Option<&models::ImportHumanUserResponsePasswordlessRegistration> {
