...
pub struct Zitadelmanagementv1GetDefaultVerifySmsotpMessageTextResponse {
  #[serde(rename = "customText")]
  custom_text: Option<models::V1MessageCustomText>
}

impl Zitadelmanagementv1GetDefaultVerifySmsotpMessageTextResponse {
  pub fn new() -> Zitadelmanagementv1GetDefaultVerifySmsotpMessageTextResponse {
  ...
  pub fn with_custom_text(mut self, custom_text: models::V1MessageCustomText) -> Zitadelmanagementv1GetDefaultVerifySmsotpMessageTextResponse {
    self.custom_text = Some(custom_text);
    self
  }
