...
pub struct V1InitPasswordDoneScreenText {
  #[serde(rename = "title")]
  title: Option<String>,
...
impl V1InitPasswordDoneScreenText {
  pub fn new() -> V1InitPasswordDoneScreenText {
  ...
  pub fn with_title(mut self, title: String) -> V1InitPasswordDoneScreenText {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> V1InitPasswordDoneScreenText {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_next_button_text(mut self, next_button_text: String) -> V1InitPasswordDoneScreenText {
    self.next_button_text = Some(next_button_text);
    self
  }
  ...
  pub fn with_cancel_button_text(mut self, cancel_button_text: String) -> V1InitPasswordDoneScreenText {
    self.cancel_button_text = Some(cancel_button_text);
    self
  }
