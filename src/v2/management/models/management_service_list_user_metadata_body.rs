...
impl ManagementServiceListUserMetadataBody {
  ...
  pub fn with_query(mut self, query: models::V1ListQuery) -> ManagementServiceListUserMetadataBody {
    self.query = Some(query);
    self
  }
  ...
  pub fn with_queries(mut self, queries: Vec<models::V1MetadataQuery>) -> ManagementServiceListUserMetadataBody {
    self.queries = Some(queries);
    self
  }
