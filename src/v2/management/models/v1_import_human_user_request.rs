...
pub struct V1ImportHumanUserRequest {
	...
	/// If this is set to true, the user has to change the password on the next
	/// login.
	#[serde(rename = "passwordChangeRequired")]
	password_change_required: Option<bool>,
	/// If this is set to true, you will get a link for the passwordless/passkey
	...
	/// To link your user directly with an external identity provider (Identity
	/// brokering)
	#[serde(rename = "idps")]
...
impl V1ImportHumanUserRequest {
	...
	pub fn with_phone(
		mut self,
		phone: models::V1ImportHumanUserRequestPhone,
	) -> V1ImportHumanUserRequest {
		self.phone = Some(phone);
		self
	}
	...
	pub fn set_hashed_password(
		&mut self,
		hashed_password: models::V1ImportHumanUserRequestHashedPassword,
	) {
	...
	pub fn with_password_change_required(
		mut self,
	...
	pub fn set_request_passwordless_registration(
		&mut self,
	...
	pub fn with_request_passwordless_registration(
		mut self,
		request_passwordless_registration: bool,
	) -> V1ImportHumanUserRequest {
		self.request_passwordless_registration = Some(request_passwordless_registration);
	...
	pub fn with_idps(
		mut self,
		idps: Vec<models::V1ImportHumanUserRequestIdp>,
	) -> V1ImportHumanUserRequest {
		self.idps = Some(idps);
		self
	}
