...
pub struct V1ListOrgMembersRequest {
  #[serde(rename = "query")]
...
impl V1ListOrgMembersRequest {
  pub fn new() -> V1ListOrgMembersRequest {
  ...
  pub fn with_query(mut self, query: models::V1ListQuery) -> V1ListOrgMembersRequest {
    self.query = Some(query);
    self
  }
  ...
  pub fn with_queries(mut self, queries: Vec<models::Zitadelmemberv1SearchQuery>) -> V1ListOrgMembersRequest {
    self.queries = Some(queries);
    self
  }
