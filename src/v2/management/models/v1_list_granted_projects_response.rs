...
pub struct V1ListGrantedProjectsResponse {
...
impl V1ListGrantedProjectsResponse {
  pub fn new() -> V1ListGrantedProjectsResponse {
  ...
  pub fn with_details(mut self, details: models::V1ListDetails) -> V1ListGrantedProjectsResponse {
    self.details = Some(details);
    self
  }
  ...
  pub fn with_result(mut self, result: Vec<models::V1GrantedProject>) -> V1ListGrantedProjectsResponse {
    self.result = Some(result);
    self
  }
