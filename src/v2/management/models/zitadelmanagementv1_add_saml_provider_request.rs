...
pub struct Zitadelmanagementv1AddSamlProviderRequest {
  #[serde(rename = "name")]
  name: Option<String>,
...
impl Zitadelmanagementv1AddSamlProviderRequest {
  pub fn new() -> Zitadelmanagementv1AddSamlProviderRequest {
  ...
  pub fn with_name(mut self, name: String) -> Zitadelmanagementv1AddSamlProviderRequest {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_metadata_xml(mut self, metadata_xml: String) -> Zitadelmanagementv1AddSamlProviderRequest {
    self.metadata_xml = Some(metadata_xml);
    self
  }
  ...
  pub fn with_metadata_url(mut self, metadata_url: String) -> Zitadelmanagementv1AddSamlProviderRequest {
    self.metadata_url = Some(metadata_url);
    self
  }
  ...
  pub fn with_binding(mut self, binding: models::V1SamlBinding) -> Zitadelmanagementv1AddSamlProviderRequest {
    self.binding = Some(binding);
    self
  }
  ...
  pub fn with_with_signed_request(mut self, with_signed_request: bool) -> Zitadelmanagementv1AddSamlProviderRequest {
    self.with_signed_request = Some(with_signed_request);
    self
  }
  ...
  pub fn with_provider_options(mut self, provider_options: models::V1Options) -> Zitadelmanagementv1AddSamlProviderRequest {
    self.provider_options = Some(provider_options);
    self
  }
  ...
  pub fn with_name_id_format(mut self, name_id_format: models::V1SamlNameIdFormat) -> Zitadelmanagementv1AddSamlProviderRequest {
    self.name_id_format = Some(name_id_format);
    self
  }
  ...
  pub fn with_transient_mapping_attribute_name(mut self, transient_mapping_attribute_name: String) -> Zitadelmanagementv1AddSamlProviderRequest {
    self.transient_mapping_attribute_name = Some(transient_mapping_attribute_name);
    self
  }
