...
pub struct Zitadelmanagementv1AddSamlProviderRequest {
	...
	/// Optionally specify the name of the attribute, which will be used to map
	/// the user in case the nameid-format returned is
...
impl Zitadelmanagementv1AddSamlProviderRequest {
	...
	pub fn with_with_signed_request(
		mut self,
