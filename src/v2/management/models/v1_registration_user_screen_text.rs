...
impl V1RegistrationUserScreenText {
  ...
  pub fn with_description_org_register(mut self, description_org_register: String) -> V1RegistrationUserScreenText {
    self.description_org_register = Some(description_org_register);
    self
  }
  ...
  pub fn with_password_confirm_label(mut self, password_confirm_label: String) -> V1RegistrationUserScreenText {
    self.password_confirm_label = Some(password_confirm_label);
    self
  }
  ...
  pub fn with_tos_and_privacy_label(mut self, tos_and_privacy_label: String) -> V1RegistrationUserScreenText {
    self.tos_and_privacy_label = Some(tos_and_privacy_label);
    self
  }
  ...
  pub fn with_privacy_link_text(mut self, privacy_link_text: String) -> V1RegistrationUserScreenText {
    self.privacy_link_text = Some(privacy_link_text);
    self
  }
  ...
  pub fn with_next_button_text(mut self, next_button_text: String) -> V1RegistrationUserScreenText {
    self.next_button_text = Some(next_button_text);
    self
  }
  ...
  pub fn with_back_button_text(mut self, back_button_text: String) -> V1RegistrationUserScreenText {
    self.back_button_text = Some(back_button_text);
    self
  }
