...
pub struct V1AddCustomPasswordComplexityPolicyRequest {
...
impl V1AddCustomPasswordComplexityPolicyRequest {
  pub fn new() -> V1AddCustomPasswordComplexityPolicyRequest {
  ...
  pub fn with_min_length(mut self, min_length: String) -> V1AddCustomPasswordComplexityPolicyRequest {
    self.min_length = Some(min_length);
    self
  }
  ...
  pub fn with_has_uppercase(mut self, has_uppercase: bool) -> V1AddCustomPasswordComplexityPolicyRequest {
    self.has_uppercase = Some(has_uppercase);
    self
  }
  ...
  pub fn with_has_lowercase(mut self, has_lowercase: bool) -> V1AddCustomPasswordComplexityPolicyRequest {
    self.has_lowercase = Some(has_lowercase);
    self
  }
  ...
  pub fn with_has_number(mut self, has_number: bool) -> V1AddCustomPasswordComplexityPolicyRequest {
    self.has_number = Some(has_number);
    self
  }
  ...
  pub fn with_has_symbol(mut self, has_symbol: bool) -> V1AddCustomPasswordComplexityPolicyRequest {
    self.has_symbol = Some(has_symbol);
    self
  }
