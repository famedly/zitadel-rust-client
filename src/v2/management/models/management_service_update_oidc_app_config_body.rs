...
impl ManagementServiceUpdateOidcAppConfigBody {
  ...
  pub fn with_redirect_uris(mut self, redirect_uris: Vec<String>) -> ManagementServiceUpdateOidcAppConfigBody {
    self.redirect_uris = Some(redirect_uris);
    self
  }
  ...
  pub fn with_response_types(mut self, response_types: Vec<models::V1OidcResponseType>) -> ManagementServiceUpdateOidcAppConfigBody {
    self.response_types = Some(response_types);
    self
  }
  ...
  pub fn with_grant_types(mut self, grant_types: Vec<models::V1OidcGrantType>) -> ManagementServiceUpdateOidcAppConfigBody {
    self.grant_types = Some(grant_types);
    self
  }
  ...
  pub fn with_app_type(mut self, app_type: models::V1OidcAppType) -> ManagementServiceUpdateOidcAppConfigBody {
    self.app_type = Some(app_type);
    self
  }
  ...
  pub fn with_auth_method_type(mut self, auth_method_type: models::V1OidcAuthMethodType) -> ManagementServiceUpdateOidcAppConfigBody {
    self.auth_method_type = Some(auth_method_type);
    self
  }
  ...
  pub fn with_post_logout_redirect_uris(mut self, post_logout_redirect_uris: Vec<String>) -> ManagementServiceUpdateOidcAppConfigBody {
    self.post_logout_redirect_uris = Some(post_logout_redirect_uris);
    self
  }
  ...
  pub fn with_access_token_type(mut self, access_token_type: models::V1OidcTokenType) -> ManagementServiceUpdateOidcAppConfigBody {
    self.access_token_type = Some(access_token_type);
    self
  }
  ...
  pub fn with_access_token_role_assertion(mut self, access_token_role_assertion: bool) -> ManagementServiceUpdateOidcAppConfigBody {
    self.access_token_role_assertion = Some(access_token_role_assertion);
    self
  }
  ...
  pub fn with_id_token_role_assertion(mut self, id_token_role_assertion: bool) -> ManagementServiceUpdateOidcAppConfigBody {
    self.id_token_role_assertion = Some(id_token_role_assertion);
    self
  }
  ...
  pub fn with_id_token_userinfo_assertion(mut self, id_token_userinfo_assertion: bool) -> ManagementServiceUpdateOidcAppConfigBody {
    self.id_token_userinfo_assertion = Some(id_token_userinfo_assertion);
    self
  }
  ...
  pub fn with_clock_skew(mut self, clock_skew: String) -> ManagementServiceUpdateOidcAppConfigBody {
    self.clock_skew = Some(clock_skew);
    self
  }
  ...
  pub fn with_additional_origins(mut self, additional_origins: Vec<String>) -> ManagementServiceUpdateOidcAppConfigBody {
    self.additional_origins = Some(additional_origins);
    self
  }
  ...
  pub fn with_skip_native_app_success_page(mut self, skip_native_app_success_page: bool) -> ManagementServiceUpdateOidcAppConfigBody {
    self.skip_native_app_success_page = Some(skip_native_app_success_page);
    self
  }
  ...
  pub fn with_back_channel_logout_uri(mut self, back_channel_logout_uri: String) -> ManagementServiceUpdateOidcAppConfigBody {
    self.back_channel_logout_uri = Some(back_channel_logout_uri);
    self
  }
  ...
  pub fn with_login_version(mut self, login_version: models::V1LoginVersion) -> ManagementServiceUpdateOidcAppConfigBody {
    self.login_version = Some(login_version);
    self
  }
