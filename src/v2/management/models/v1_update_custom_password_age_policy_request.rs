...
impl V1UpdateCustomPasswordAgePolicyRequest {
  ...
  pub fn with_max_age_days(mut self, max_age_days: i64) -> V1UpdateCustomPasswordAgePolicyRequest {
    self.max_age_days = Some(max_age_days);
    self
  }
  ...
  pub fn with_expire_warn_days(mut self, expire_warn_days: i64) -> V1UpdateCustomPasswordAgePolicyRequest {
    self.expire_warn_days = Some(expire_warn_days);
    self
  }
