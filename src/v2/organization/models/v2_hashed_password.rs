...
impl V2HashedPassword {
	pub fn new(hash: String) -> V2HashedPassword {
		V2HashedPassword { hash: hash, change_required: None }
	}
	...
	pub fn with_hash(mut self, hash: String) -> V2HashedPassword {
		self.hash = hash;
		self
	}
	...
	pub fn with_change_required(mut self, change_required: bool) -> V2HashedPassword {
		self.change_required = Some(change_required);
		self
	}
