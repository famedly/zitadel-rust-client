...
pub struct V2ListExecutionMethodsResponse {
	#[serde(rename = "methods")]
	methods: Option<Vec<String>>,
}

impl V2ListExecutionMethodsResponse {
	pub fn new() -> V2ListExecutionMethodsResponse {
		V2ListExecutionMethodsResponse { methods: None }
	}
	...
	pub fn with_methods(mut self, methods: Vec<String>) -> V2ListExecutionMethodsResponse {
		self.methods = Some(methods);
		self
	}
