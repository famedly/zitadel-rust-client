...
pub struct V2InTargetIdsFilter {
	/// the ids of the targets to include
	#[serde(rename = "targetIds")]
	target_ids: Option<Vec<String>>,
}

impl V2InTargetIdsFilter {
	pub fn new() -> V2InTargetIdsFilter {
		V2InTargetIdsFilter { target_ids: None }
	}
	...
	pub fn with_target_ids(mut self, target_ids: Vec<String>) -> V2InTargetIdsFilter {
		self.target_ids = Some(target_ids);
		self
	}
