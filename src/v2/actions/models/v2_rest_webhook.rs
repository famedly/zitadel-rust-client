...
impl V2RestWebhook {
	pub fn new() -> V2RestWebhook {
		V2RestWebhook { interrupt_on_error: None }
	}
	...
	pub fn with_interrupt_on_error(mut self, interrupt_on_error: bool) -> V2RestWebhook {
		self.interrupt_on_error = Some(interrupt_on_error);
		self
	}
