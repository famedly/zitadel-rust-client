...
pub struct V2ListExecutionServicesResponse {
	#[serde(rename = "services")]
	services: Option<Vec<String>>,
}

impl V2ListExecutionServicesResponse {
	pub fn new() -> V2ListExecutionServicesResponse {
		V2ListExecutionServicesResponse { services: None }
	}
	...
	pub fn with_services(mut self, services: Vec<String>) -> V2ListExecutionServicesResponse {
		self.services = Some(services);
		self
	}
