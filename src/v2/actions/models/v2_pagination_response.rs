...
pub struct V2PaginationResponse {
...
impl V2PaginationResponse {
	pub fn new() -> V2PaginationResponse {
		V2PaginationResponse { total_result: None, applied_limit: None }
	}
	...
	pub fn with_total_result(mut self, total_result: String) -> V2PaginationResponse {
		self.total_result = Some(total_result);
		self
	}
	...
	pub fn with_applied_limit(mut self, applied_limit: String) -> V2PaginationResponse {
		self.applied_limit = Some(applied_limit);
		self
	}
