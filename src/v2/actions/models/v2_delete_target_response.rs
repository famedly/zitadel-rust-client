...
pub struct V2DeleteTargetResponse {
...
impl V2DeleteTargetResponse {
	pub fn new() -> V2DeleteTargetResponse {
		V2DeleteTargetResponse { deletion_date: None }
	}
	...
	pub fn with_deletion_date(mut self, deletion_date: String) -> V2DeleteTargetResponse {
		self.deletion_date = Some(deletion_date);
		self
	}
