...
pub struct V2UpdateTargetResponse {
...
impl V2UpdateTargetResponse {
	pub fn new() -> V2UpdateTargetResponse {
		V2UpdateTargetResponse { change_date: None, signing_key: None }
	}
	...
	pub fn with_change_date(mut self, change_date: String) -> V2UpdateTargetResponse {
		self.change_date = Some(change_date);
		self
	}
	...
	pub fn with_signing_key(mut self, signing_key: String) -> V2UpdateTargetResponse {
		self.signing_key = Some(signing_key);
		self
	}
