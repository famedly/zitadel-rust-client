...
pub struct V2betaListExecutionsRequest {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	sorting_column: Option<super::V2betaExecutionFieldName>,
	/// Define the criteria to query for.
	#[serde(rename = "filters")]
	#[serde(skip_serializing_if = "Option::is_none")]
	filters: Option<Vec<super::V2betaExecutionSearchFilter>>,
}

impl V2betaListExecutionsRequest {
	pub fn new() -> V2betaListExecutionsRequest {
		V2betaListExecutionsRequest { pagination: None, sorting_column: None, filters: None }
	}
	...
	pub fn set_sorting_column(&mut self, sorting_column: super::V2betaExecutionFieldName) {
		self.sorting_column = Some(sorting_column);
	}

	pub fn with_sorting_column(
		mut self,
		sorting_column: super::V2betaExecutionFieldName,
	) -> V2betaListExecutionsRequest {
		self.sorting_column = Some(sorting_column);
		self
	}

	pub fn sorting_column(&self) -> Option<&super::V2betaExecutionFieldName> {
	...
	pub fn set_filters(&mut self, filters: Vec<super::V2betaExecutionSearchFilter>) {
		self.filters = Some(filters);
	}

	pub fn with_filters(
		mut self,
		filters: Vec<super::V2betaExecutionSearchFilter>,
	) -> V2betaListExecutionsRequest {
		self.filters = Some(filters);
		self
	}

	pub fn filters(&self) -> Option<&Vec<super::V2betaExecutionSearchFilter>> {
		self.filters.as_ref()
	}
...
impl PaginationRequest<V2betaListExecutionsRequest>
	for (
		Option<PaginationParams>,
		Option<super::V2betaExecutionFieldName>,
		Option<Vec<super::V2betaExecutionSearchFilter>>,
	)
{
	#[allow(clippy::cast_possible_wrap)]
	fn to_paginated_request(&self, page: usize) -> V2betaListExecutionsRequest {
