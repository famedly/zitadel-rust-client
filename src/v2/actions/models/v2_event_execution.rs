...
impl V2EventExecution {
	pub fn new() -> V2EventExecution {
		V2EventExecution { event: None, group: None, all: None }
	}
	...
	pub fn with_event(mut self, event: String) -> V2EventExecution {
		self.event = Some(event);
		self
	}
	...
	pub fn with_group(mut self, group: String) -> V2EventExecution {
		self.group = Some(group);
		self
	}
	...
	pub fn with_all(mut self, all: bool) -> V2EventExecution {
		self.all = Some(all);
		self
	}
