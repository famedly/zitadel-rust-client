...
impl V2RestCall {
	pub fn new() -> V2RestCall {
		V2RestCall { interrupt_on_error: None }
	}
	...
	pub fn with_interrupt_on_error(mut self, interrupt_on_error: bool) -> V2RestCall {
		self.interrupt_on_error = Some(interrupt_on_error);
		self
	}
