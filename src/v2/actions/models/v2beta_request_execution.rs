...
pub struct V2betaRequestExecution {
...
impl V2betaRequestExecution {
	pub fn new() -> V2betaRequestExecution {
		V2betaRequestExecution { method: None, service: None, all: None }
	}
	...
	pub fn with_method(mut self, method: String) -> V2betaRequestExecution {
		self.method = Some(method);
		self
	}
	...
	pub fn with_service(mut self, service: String) -> V2betaRequestExecution {
		self.service = Some(service);
		self
	}
	...
	pub fn with_all(mut self, all: bool) -> V2betaRequestExecution {
		self.all = Some(all);
		self
	}
