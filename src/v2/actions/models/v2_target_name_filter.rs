...
pub struct V2TargetNameFilter {
	/// Defines the name of the target to query for.
	#[serde(rename = "targetName")]
	target_name: Option<String>,
	/// defines which text equality method is used
	#[serde(rename = "method")]
	method: Option<super::V2TextFilterMethod>,
}

impl V2TargetNameFilter {
	pub fn new() -> V2TargetNameFilter {
		V2TargetNameFilter { target_name: None, method: None }
	}
	...
	pub fn with_target_name(mut self, target_name: String) -> V2TargetNameFilter {
		self.target_name = Some(target_name);
		self
	}
	...
	pub fn set_method(&mut self, method: super::V2TextFilterMethod) {
		self.method = Some(method);
	}

	pub fn with_method(mut self, method: super::V2TextFilterMethod) -> V2TargetNameFilter {
		self.method = Some(method);
		self
	}

	pub fn method(&self) -> Option<&super::V2TextFilterMethod> {
		self.method.as_ref()
	}
