...
pub struct V2ResponseExecution {
...
impl V2ResponseExecution {
	pub fn new() -> V2ResponseExecution {
		V2ResponseExecution { method: None, service: None, all: None }
	}
	...
	pub fn with_method(mut self, method: String) -> V2ResponseExecution {
		self.method = Some(method);
		self
	}
	...
	pub fn with_service(mut self, service: String) -> V2ResponseExecution {
		self.service = Some(service);
		self
	}
	...
	pub fn with_all(mut self, all: bool) -> V2ResponseExecution {
		self.all = Some(all);
		self
	}
