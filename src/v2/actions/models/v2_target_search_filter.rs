...
pub struct V2TargetSearchFilter {
	#[serde(rename = "targetNameFilter")]
	target_name_filter: Option<super::V2TargetNameFilter>,
	#[serde(rename = "inTargetIdsFilter")]
	in_target_ids_filter: Option<super::V2InTargetIdsFilter>,
}

impl V2TargetSearchFilter {
	pub fn new() -> V2TargetSearchFilter {
		V2TargetSearchFilter { target_name_filter: None, in_target_ids_filter: None }
	}

	pub fn set_target_name_filter(&mut self, target_name_filter: super::V2TargetNameFilter) {
		self.target_name_filter = Some(target_name_filter);
	}

	pub fn with_target_name_filter(
		mut self,
		target_name_filter: super::V2TargetNameFilter,
	) -> V2TargetSearchFilter {
		self.target_name_filter = Some(target_name_filter);
		self
	}

	pub fn target_name_filter(&self) -> Option<&super::V2TargetNameFilter> {
	...
	pub fn in_target_ids_filter(&self) -> Option<&super::V2InTargetIdsFilter> {
