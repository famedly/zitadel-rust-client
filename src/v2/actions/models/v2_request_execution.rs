...
impl V2RequestExecution {
	pub fn new() -> V2RequestExecution {
		V2RequestExecution { method: None, service: None, all: None }
	}
	...
	pub fn with_method(mut self, method: String) -> V2RequestExecution {
		self.method = Some(method);
		self
	}
	...
	pub fn with_service(mut self, service: String) -> V2RequestExecution {
		self.service = Some(service);
		self
	}
	...
	pub fn with_all(mut self, all: bool) -> V2RequestExecution {
		self.all = Some(all);
		self
	}
