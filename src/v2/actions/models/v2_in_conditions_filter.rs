...
pub struct V2InConditionsFilter {
	/// Defines the conditions to query for.
	#[serde(rename = "conditions")]
	conditions: Option<Vec<super::V2Condition>>,
}

impl V2InConditionsFilter {
	pub fn new() -> V2InConditionsFilter {
		V2InConditionsFilter { conditions: None }
	}

	pub fn set_conditions(&mut self, conditions: Vec<super::V2Condition>) {
	...
	pub fn conditions(&self) -> Option<&Vec<super::V2Condition>> {
