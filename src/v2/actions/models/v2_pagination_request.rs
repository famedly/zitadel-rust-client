...
pub struct V2PaginationRequest {
...
impl V2PaginationRequest {
	pub fn new() -> V2PaginationRequest {
		V2PaginationRequest { offset: None, limit: None, asc: None }
	}
	...
	pub fn with_offset(mut self, offset: String) -> V2PaginationRequest {
		self.offset = Some(offset);
		self
	}
	...
	pub fn with_limit(mut self, limit: i64) -> V2PaginationRequest {
		self.limit = Some(limit);
		self
	}
	...
	pub fn with_asc(mut self, asc: bool) -> V2PaginationRequest {
		self.asc = Some(asc);
		self
	}
