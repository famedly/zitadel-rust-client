...
pub struct V2ListExecutionFunctionsResponse {
	#[serde(rename = "functions")]
	functions: Option<Vec<String>>,
}

impl V2ListExecutionFunctionsResponse {
	pub fn new() -> V2ListExecutionFunctionsResponse {
		V2ListExecutionFunctionsResponse { functions: None }
	}
