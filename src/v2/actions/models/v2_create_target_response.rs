...
pub struct V2CreateTargetResponse {
...
impl V2CreateTargetResponse {
	pub fn new() -> V2CreateTargetResponse {
		V2CreateTargetResponse { id: None, creation_date: None, signing_key: None }
	}
	...
	pub fn with_id(mut self, id: String) -> V2CreateTargetResponse {
		self.id = Some(id);
		self
	}
	...
	pub fn with_creation_date(mut self, creation_date: String) -> V2CreateTargetResponse {
		self.creation_date = Some(creation_date);
		self
	}
	...
	pub fn with_signing_key(mut self, signing_key: String) -> V2CreateTargetResponse {
		self.signing_key = Some(signing_key);
		self
	}
