...
impl ResendEmailCodeResponse {
	pub fn new() -> ResendEmailCodeResponse {
		ResendEmailCodeResponse { details: None, verification_code: None }
	}
	...
	pub fn with_details(mut self, details: models::Details) -> ResendEmailCodeResponse {
		self.details = Some(details);
		self
	}
	...
	pub fn with_verification_code(mut self, verification_code: String) -> ResendEmailCodeResponse {
		self.verification_code = Some(verification_code);
		self
	}
